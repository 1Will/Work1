...
<@ww.form name="'listForm'" action="''" method="'post'">
	...
	<tr>
  		<@ww.textfield label="'订单数量'" name="'customerName'" value="''" cssClass="'underline'"/>
	...
	<tr>
		...
		<@ww.textfield label="'人均访问次数'" name="'customerCode'" value="''" cssClass="'underline'"/>
		<@ww.textfield label="'业务员行动完成率'" name="'customerCode'" value="''" cssClass="'underline'"/>
	</tr>
	<tr>
	...
	<tr>
 	...
 	<tr>
			...
			<script language="javascript">
				...
				getObjByName("customerInfo").cols =width;
			</script>
	</tr>	
	...
	<@buttonBar>
		...
		<@redirectButton value="${'返回'}" url="listDepartmentTarget_.html"/>
    </@buttonBar>
</@ww.form>
</@htmlPage>