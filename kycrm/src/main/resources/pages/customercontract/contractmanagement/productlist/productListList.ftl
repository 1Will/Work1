...
<@framePage>
	<@ww.form name="'listForm'" action="'searchProductList'" method="'post'">
        ...
        <@list title="" 
            includeParameters="contractManagement.id|onlyInvalid|startTime|endTime|month|onlyValid" 
        	fieldMap="like:" >
	        ...
	        <@vcolumn title="${action.getText('productList.product')}"  property="product.name" >
         	...
         	<@vcolumn title="${action.getText('房间编码')}"  property="house.code" >
            	<@alignLeft/>
         	</@vcolumn>
         	...
         	<@vcolumn title="${action.getText('月数')}" property="month" sortable="desc">
            	<@alignRight/>
         	</@vcolumn>
