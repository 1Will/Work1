...
<@ww.form namespace="'/com'" name="'com'" action="'saveRejection'" method="'post'">
    ...
    <@inputTable>
		...
		<tr>
			...
			<td colspan=10">
				<textarea name="rejection.reason" rows="4"  >${rejection.reason?if_exists}</textarea>
			</td>
			<script language="javascript">
			var width=document.body.clientWidth/9;
						getObjByName("rejection.reason").cols =width;
		   </script>
		</tr>
		<tr>
			<td align="right" valign="top">
			...
			<td colspan=10">
				<textarea name="rejection.remark" rows="4"  >${rejection.remark?if_exists}</textarea>
			</td>
			<script language="javascript">
			var width=document.body.clientWidth/9;
						getObjByName("rejection.remark").cols =width;
		   </script>
		</tr>
    </@inputTable>
    <@buttonBar>
