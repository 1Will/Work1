...
<@ww.form namespace="'/com'" name="'com'" action="'saveContractCustomer'" method="'post'">
    ...
    <@inputTable>
		...
		<tr>
			...
			<td colspan=10">
				<textarea name="contractCustomer.content" rows="4"  >${contractCustomer.content?if_exists}</textarea>
			</td>
			<script language="javascript">
			var width=document.body.clientWidth/9;
						getObjByName("contractCustomer.content").cols =width;
		   </script>
		</tr>
		<tr>
			<td align="right" valign="top">
			...
			<td colspan=10">
				<textarea name="contractCustomer.remark" rows="4"  >${contractCustomer.remark?if_exists}</textarea>
			</td>
			<script language="javascript">
			var width=document.body.clientWidth/9;
						getObjByName("contractCustomer.remark").cols =width;
		   </script>
		</tr>
    </@inputTable>
    <@buttonBar>
