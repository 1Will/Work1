...
<@ww.form namespace="'/activity'" name="'activityProfile'" action="'saveActivity'" method="'post'">
    ...
    <@inputTable>
		...
		<tr>		
			...
			<td colspan=10">
				<textarea name="activity.summary" rows="4" >${activity.summary?if_exists}</textarea>
			</td>
			<script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("activity.summary").cols =width;
			</script>
		</tr>
		<tr>
			<td align="right" valign="top">
			...
			<td colspan=10">
				<textarea name="activity.comment" rows="4" >${activity.comment?if_exists}</textarea>
			</td>
			<script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("activity.comment").cols =width;
			</script>
		</tr>
		<tr>
			<td align="right" valign="top">
			...
			<td colspan=10">
				<textarea name="activity.remark" rows="4"  >${activity.remark?if_exists}</textarea>
			</td>
			<script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("activity.remark").cols =width;
			</script>
		</tr>
    </@inputTable>
    <@buttonBar>
