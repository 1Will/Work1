...
<@ww.form name="'listForm'" action="'saveCustomerComplaintAction'" method="'post'">
	...
	<@inputTable>
		...
		<tr>
	        ...
	        <td colspan="10">
	        	<textarea name="customerComplaint.complaintContent" rows="4"  >${customerComplaint.complaintContent?if_exists}</textarea>
	        </td>
	        <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("customerComplaint.complaintContent").cols =width;
			</script>
		</tr>
		...
		<tr>
	        ...
	        <td colspan="10">
	        	<textarea name="customerComplaint.disposeContent" rows="4"  >${customerComplaint.disposeContent?if_exists}</textarea>
	        </td>
	         <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("customerComplaint.disposeContent").cols =width;
			</script>
		</tr>
		<tr>
			<td align="right" valign="top">
	        ...
	        <td colspan="10">
	        	<textarea name="customerComplaint.customerFeedback" rows="4"  >${customerComplaint.customerFeedback?if_exists}</textarea>
	        </td>
	         <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("customerComplaint.customerFeedback").cols =width;
			</script>
		</tr>
		<tr>
			<td align="right" valign="top">
	        ...
	        <td colspan="10">
	        	<textarea name="customerComplaint.remark" rows="4" cols="150"
	        <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("customerComplaint.remark").cols =width;
			</script>
		</tr>
