...
<@ww.form name="'listForm'" action="'saveQaStorageAction'" method="'post'">
	...
	<@inputTable>
		...
		<tr>
	        ...
	        <td colspan="10">
	        	<textarea name="qaStorage.question" rows="4" >${qaStorage.question?if_exists}</textarea>
	        </td>
	        <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("qaStorage.question").cols =width;
			</script>
		</tr>
		<tr>
			<td align="right" valign="top">
	        ...
	        <td colspan="10">
	        	<textarea name="qaStorage.resolveProject" rows="4" >${qaStorage.resolveProject?if_exists}</textarea>
	        </td>
	          <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("qaStorage.resolveProject").cols =width;
			</script>
		</tr>
		...
		<tr>
	        ...
	        <td colspan="10">
	        	<textarea name="qaStorage.innerPrompt" rows="4"  >${qaStorage.innerPrompt?if_exists}</textarea>
	        </td>
	         <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("qaStorage.innerPrompt").cols =width;
			</script>
		</tr>
		...
		<tr>
	        ...
	        <td colspan="10">
	        	<textarea name="qaStorage.remark" rows="4" >${qaStorage.remark?if_exists}</textarea>
	        </td>
	        <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("qaStorage.remark").cols =width;
			</script>
		</tr>
	...
	<#if !(action.isReadOnly())>
		...
		<@redirectButton value="${action.getText('back')}" url="${req.contextPath}/qaStorage/listQaStorageAction.html?readOnly=${req.getParameter('readOnly')?if_exists}"/>
    </@buttonBar>
</@ww.form>
