...
<@ww.form name="'listForm'" action="'saveRepairsAction'" method="'post'">
	...
	<@inputTable>
		...
		<tr>
	        ...
	        <td colspan="5">
	        	<textarea name="repairs.detail" rows="6"  >${repairs.detail?if_exists}</textarea>
	        </td>
	        <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("repairs.detail").cols =width;
			</script>
		</tr>
		<tr>
			<td align="right" valign="top">
	        ...
	        <td colspan="5">
	        	<textarea name="repairs.remark" rows="6"  >${repairs.remark?if_exists}</textarea>
	        </td>
	          <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("repairs.remark").cols =width;
			</script>
		</tr>
	</@inputTable>
	<@buttonBar>
