...
<@ww.form namespace="'/paymentorder'"  name="'paymentorder'" action="'savePaymentorderAction'" method="'post'">
	...
	<@inputTable>
		<tr>
			<@textfield id="code" disabled="true" label="${action.getText('paymentorder.code')}" maxlength="10"  name="paymentorder.code"  value="${paymentorder.code?if_exists}"  required="false" anothername="checkcode" readonly="true"/>
