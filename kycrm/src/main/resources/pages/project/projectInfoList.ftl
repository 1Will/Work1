...
<@htmlPage title="${action.getText('projectInfo')}">
	<@ww.form name="'listForm'" namespace="'/projectInfo'" action="'searchProjectInfo'" method="'post'">
        ...
        includeParameters="code|name|customer.name|customer.id|contact.name|backVisitCheckBox|controller.name|state.id|readOnly|onlyInvalid|onlyValid|personnelFiles.id|month" 
        fieldMap="like:code|name|customer.name|contact.name|controller.name|month" >
