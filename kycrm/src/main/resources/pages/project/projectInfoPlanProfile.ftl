...
<@ww.form namespace="'/projectInfo'" name="'projectInfo'" action="'saveProPlan'" method="'post'">
  ...
  <tr>
         <td align="right" valign="top">
	     	...
	     	<td>
		   		<input type="text" name="projectInfoPlan_2.name" class="underline"  value="<#if projectInfoPlan.projectInfoPlan_2?exists>${projectInfoPlan.projectInfoPlan_2.name?if_exists}</#if>" maxlength="140" size="80" disabled="true"/>
	...
	function salesman_OpenDialog(){
	 ...
	 function projectInfoPlanFirst_OpenDialog(){
	   var projectInfoPlan_2Id=getObjByName("projectInfoPlan_2.id").value;
		<#if projectInfoId?exists>
		 	var url =  "${req.contextPath}/projectInfo/listProPlan.html?readOnly=${req.getParameter('readOnly')?if_exists}&projectInfo.id=${projectInfoId?if_exists}&backCheckBox=backCheckBox&projectInfoPlan.id=${projectInfoPlan.id?if_exists}&projectInfoPlan_2Id="+projectInfoPlan_2Id;
    	</#if>
    	<#if contractManagement?exists>
    	<#if contractManagement.id?exists>
		 	var url =  "${req.contextPath}/projectInfo/listProPlan.html?readOnly=${req.getParameter('readOnly')?if_exists}&contractManagement.id=${contractManagement.id?if_exists}&backCheckBox=backCheckBox&projectInfoPlan.id=${projectInfoPlan.id?if_exists}&projectInfoPlan_2Id="+projectInfoPlan_2Id;
    	</#if>
    	</#if>
