...
<@ww.form namespace="'/projectInfo'" name="'projectInfo'" action="'saveProjectContactArchives'" method="'post'">
    ...
    <tr>
	        ...
	        <td colspan="10">
	        	<textarea name="projectContactArchives.outline" rows="4" >${projectContactArchives.outline?if_exists}</textarea>
	        	<script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("projectContactArchives.outline").cols =width;
			</script>
	        </td>
			<!---->
		</tr>
