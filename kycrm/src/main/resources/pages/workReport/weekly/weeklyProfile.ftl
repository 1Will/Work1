     	 ...
     	 <@ww.token name="saveWeeklyToken"/>
     	  <@inputTable>
			...
			<tr>
		        ...
		        <td colspan="10">
		        	<textarea id="weekly.summary" name="weekly.summary" rows="4"  >${weekly.summary?if_exists}</textarea>
		        </td>
		        <script language="javascript">
					var width=document.body.clientWidth/9;
					getObjByName("weekly.summary").cols =width;
				</script>
			</tr>
			...
			<tr>
		        ...
		        <td colspan="10">
		        	<textarea id="weekly.leaderIdea" name="weekly.leaderIdea" rows="4" >${weekly.leaderIdea?if_exists}</textarea>
		        </td>
		          <script language="javascript">
					var width=document.body.clientWidth/9;
					getObjByName("weekly.leaderIdea").cols =width;
				</script>
			</tr>
			<tr>
				<td align="right" valign="top">
		        ...
		        <td colspan="10">
		        	<textarea name="weekly.comment" rows="4"  >${weekly.comment?if_exists}</textarea>
		        </td>
		         <script language="javascript">
					var width=document.body.clientWidth/9;
					getObjByName("weekly.comment").cols =width;
				</script>
			</tr>
     	  </@inputTable>
     	  <@buttonBar>
...
<script type="text/javascript">
		...
		function week_OpenDialog(){
			 var url = "${req.contextPath}/workReport/listWeek.html?readOnly=${req.getParameter('readOnly')?if_exists}&filterWeek=filterWeek";
