...
<script language="javascript">
   //弹出合同模态窗体
	function listContract_OpenDialog(id,month){
	   ...
	   var url = "${req.contextPath}/contractManagement/listContractManagementAction.html?readOnly=${req.getParameter('readOnly')?if_exists}&month="+month; 
	   openNewWindow(url);
	 }
	 //弹收款模态窗体
	function listFinancial_OpenDialog(id,month){
			 month=month.replace('年','-').replace('月','');
	   var url = "${req.contextPath}/financialManagement/listFinancialManagement.html?readOnly=${req.getParameter('readOnly')?if_exists}&month="+month; 
	   openNewWindow(url);
	 }
	...
	function billingRecord_OpenDialog(id,month){
			 month=month.replace('年','-').replace('月','');
	   var url = "${req.contextPath}/contractManagement/listBillingRecord.html?readOnly=${req.getParameter('readOnly')?if_exists}&month="+month; 
	   openNewWindow(url);
	 }
     //弹出日报模态窗体
	...
	function listDaily_OpenDialog(id,month){
			 month=month.replace('年','-').replace('月','');
	   var url = "${req.contextPath}/workReport/listDaily.html?readOnly=${req.getParameter('readOnly')?if_exists}&month="+month; 
	   openNewWindow(url);
	 }
	   //弹出周报模态窗体
	...
	function listWeek_OpenDialog(id,month){
			 month=month.replace('年','-').replace('月','');
	   var url = "${req.contextPath}/workReport/listWeekly.html?readOnly=${req.getParameter('readOnly')?if_exists}&month="+month; 
	   openNewWindow(url);
	 }
	  //弹出项目数模态窗体
	...
	function listProject_OpenDialog(id,month){
			 month=month.replace('年','-').replace('月','');
	   var url = "${req.contextPath}/projectInfo/listProjectInfo.html?readOnly=${req.getParameter('readOnly')?if_exists}&month="+month; 
	   openNewWindow(url);
	 }
	   //弹出回复数模态窗体
	...
	function backvisit_OpenDialog(id,month){
			 month=month.replace('年','-').replace('月','');
	   var url = "${req.contextPath}/backvisit/listBackVisit.html?readOnly=${req.getParameter('readOnly')?if_exists}&month="+month; 
	   openNewWindow(url);
	 }
