...
<@htmlPage title="${action.getText('financialManagement.title.check')}">
	<@ww.form name="'listFrom'" namespace="'/financialManagement'" action="'searchFinancialManagement'" method="'post'">
        ...
        <@buttonBar>
			...
			<@redirectButton value="${action.getText('new')}" url="${req.contextPath}/financialManagement/editFinancialManagement.html?readOnly=${req.getParameter('readOnly')?if_exists}"/>
			</#if>
        </@buttonBar>
        <@list title="${action.getText('financialManagement.list.title')}" 
        	...
        	|customerInfo.code|financialManagement.customerInfo|readOnly|onlyInvalid|onlyValid|personnelFiles.id|month" 
        	fieldMap="like:financialManagement.saleman|financialManagement.code|projectInfo.name|financialManagement.payee|financialManagement.contractManagement|customerInfo.code|financialManagement.customerInfo|month|
