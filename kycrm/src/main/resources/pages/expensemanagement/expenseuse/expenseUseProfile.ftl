...
<@ww.form name="'listForm'" action="'saveExpenseUseAction'" method="'post'">
	...
	<@inputTable>
		...
		<tr>
		    <@textarea name="expenseUse.remark" label="${action.getText('expenseUse.remark')}" anothername="remark" rows="4"  maxLength="500" required="false" value="${expenseUse.remark?if_exists}"/>
		    <script language="javascript">
				var width=document.body.clientWidth/9;
				getObjByName("expenseUse.remark").cols =width;
			</script>	
	    </tr>
		</@inputTable>
	<@buttonBar>
