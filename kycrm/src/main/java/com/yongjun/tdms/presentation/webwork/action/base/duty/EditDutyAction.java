...
public class EditDutyAction extends PrepareAction {
	...
	public String save() {
		...
		if (!StringUtils.isEmpty(this.request.getParameter("perType.id"))) {
		 ...
		 if (!StringUtils.isEmpty(this.request.getParameter("duty.setComment"))){
		     this.duty.setComment(this.request.getParameter("duty.setComment"));
		}
		 
		 if (!StringUtils.isEmpty(this.request.getParameter("duty.setCondition"))){
		     this.duty.setCondition(this.request.getParameter("duty.setCondition"));
		}
