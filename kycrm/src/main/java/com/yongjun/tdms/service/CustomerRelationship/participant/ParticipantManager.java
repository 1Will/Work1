package com.yongjun.tdms.service.CustomerRelationship.participant;
...
public interface ParticipantManager {
	public abstract void storeParticipant(Participant paramParticipant);
	  ...
	  public abstract void disabledAllParticipant(List<Participant> paramList);

	  public abstract void enabledAllParticipant(List<Participant> paramList);
