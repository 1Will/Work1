package com.yongjun.tdms.dao.expensemanagement.electricFee;
...
public interface ElectricHouseFeeDao {
	 public abstract void storeElectricHouseFee(ElectricHouseFee paramElectricHouseFee);
	  ...
	  public abstract List<ElectricHouseFee> loadByKey(String paramString, Object paramObject)
	    throws DaoException;
