...
/*     */   }
/*     */
public List<ProductList> loadProductListsByTime(long cusId,String proName, Date date) {
	SimpleDateFormat formatter=new SimpleDateFormat("yyyy-MM-dd");
	String hql="select t from ProductList t where t.contractManagement.customerInfo="+cusId+" and t.endTime>=convert(datetime,'"+formatter.format(date)+"') and  t.product.name like '%"+date+"%'";
	List <ProductList>codeList = getSession().createQuery(hql).list();
