...
public class PersonnelFiles extends BaseInfoEntity
	...
	private CodeValue professor;// 职称
	private CodeValue grade;// 等级
	private CodeValue rank;// 职级
	...
	public void setProfessor(CodeValue professor) {
