...
public class CustomerInfo extends BaseInfoEntity {
	...
	//国民经济分类
	private Industry nationalEconomyP;
	private Industry nationalEconomyC;
	private Industry technologyEconomyP;
	private Industry technologyEconomyC;
	...
	public Industry getNationalEconomyP() {
		return nationalEconomyP;
	}

	public void setNationalEconomyP(Industry nationalEconomyP) {
		this.nationalEconomyP = nationalEconomyP;
	}

	public Industry getNationalEconomyC() {
		return nationalEconomyC;
	}

	public void setNationalEconomyC(Industry nationalEconomyC) {
		this.nationalEconomyC = nationalEconomyC;
	}

	public Industry getTechnologyEconomyP() {
		return technologyEconomyP;
	}

	public void setTechnologyEconomyP(Industry technologyEconomyP) {
		this.technologyEconomyP = technologyEconomyP;
	}

	public Industry getTechnologyEconomyC() {
		return technologyEconomyC;
	}

	public void setTechnologyEconomyC(Industry technologyEconomyC) {
		this.technologyEconomyC = technologyEconomyC;
	}
