...
public class FinancialManagement extends BaseInfoEntity {
	...
	private Double sumReceivable = Double.valueOf(0.0D);//计划应收金额
	private Double trueSum = Double.valueOf(0.0D);//本次实收金额
	private Double totalSum = Double.valueOf(0.0D);//前期已收金额
	private Double withoutGotSum = Double.valueOf(0.0D);//未收金额
