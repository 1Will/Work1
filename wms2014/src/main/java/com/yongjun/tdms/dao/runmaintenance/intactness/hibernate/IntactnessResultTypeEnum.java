...
/**
 * @author qs
 * @version $Id: IntactnessResultTypeEnum.java 10781 2008-01-30 01:31:21Z qsun $
 */
public class IntactnessResultTypeEnum extends EnumType {

	@Override
	protected Class getEnumClass() {
		return IntactnessResultType.class;
	}
