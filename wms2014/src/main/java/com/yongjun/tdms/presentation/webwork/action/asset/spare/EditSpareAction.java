...
//	private Department department;
	...
	public EditSpareAction(SpareManager spareManager,
			CodeValueManager codeValueManager,
			DepartmentManager departmentManager,
			SupplierManager supplierManager, DeviceCardManager deviceCardManager,
			SpareDetailTypeManager spareDetailTypeManager,UserManager userManager,SpareTypeManager spareTypeManager,WorkWarnningManager workWarnningManager) {
...
//		}
		...
		//修改为备件备件编码为手动输入
		if (!StringUtils.isEmpty(request.getParameter("spare.spareNo"))) {
				spare.setSpareNo(request.getParameter("spare.spareNo").trim());
		}
