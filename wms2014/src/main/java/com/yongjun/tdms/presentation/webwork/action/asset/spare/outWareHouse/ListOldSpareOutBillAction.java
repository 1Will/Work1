 ...
 */
public class ListOldSpareOutBillAction extends ValueListAction{
	...
	public ListOldSpareOutBillAction(SpareOutBillManager spareOutBillManager,
...
//	获得所有仓库的集合
	...
	protected Map getRequestParameterMap() {
		...
		String inWarehouse = (String) map.get("inWarehouse.id");
		if(inWarehouse!=null&&inWarehouse.equals("-1")){
			map.remove("inWarehouse.id");
		}
		return map;
	}
	    ...
	    if(size>0){
	    	 ...
	    	 if("208".equals(storageGrade)){
	 		 ...
	 		 if(!"".equals(outWarehouse)){
	 	 		...
	 	 		allTtotlePrice = this.spareOutBillManager.showOldOutTotalPrice(param);
