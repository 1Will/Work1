 ...
 */
public class ListOldSpareMaintainBillAction extends ValueListAction{
	...
	public ListOldSpareMaintainBillAction(SpareOutBillManager spareOutBillManager,
	    ...
	    if(size>0){
	    	 ...
	    	 if("208".equals(storageGrade)){
	 		 ...
	 		 if(!"".equals(outWarehouse)){
	 	 		...
	 	 		allTtotlePrice = this.spareOutBillManager.showOldMaintainTotalPrice(param);
