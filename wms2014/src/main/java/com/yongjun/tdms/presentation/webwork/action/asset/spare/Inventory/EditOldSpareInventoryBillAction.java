 ...
 * @version Id:
 */
public class EditOldSpareInventoryBillAction extends PrepareAction{
    ...
    public EditOldSpareInventoryBillAction(SpareInventoryManager spareInventoryManager,
    		UserManager userManager,
    		EventNewManager eventNewManager,
    		WarehouseManager warehouseManager,
    		CodeValueManager codeValueManager,
    		com.yongjun.tdms.service.asset.spare.warehouseInfo.warehouse.WarehouseManager
    	    newwarehouseManager){
	...
	public String save(){
		String sId ="209";// this.request.getParameter("storageGrade.id");
		...
		if (isNew) {
			this.addActionMessage(this.getText("盘点单" + spareInventoryBill.getInventoryNo() + "保存成功",
					Arrays.asList(new Object[] {spareInventoryBill.getInventoryNo()})));
			return NEW;
		} else {
			this.addActionMessage(this.getText("盘点单" + spareInventoryBill.getInventoryNo() + "保存失败",
					Arrays.asList(new Object[] {spareInventoryBill.getInventoryNo()})));
			return SUCCESS;
		}
	}
