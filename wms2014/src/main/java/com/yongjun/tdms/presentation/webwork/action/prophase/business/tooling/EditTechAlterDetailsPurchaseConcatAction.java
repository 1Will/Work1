...
/**
 * <p>Title:EditTechAlterDetailsPurchaseConcatAction
 * <p>Description:采购合同技术改造明细维护页面控制类</P>
 * <p>Copyright:Copyright (c) 2008 yj-technology</P>
 * <p>Company:www.yj-technology.com</P>
 * @author smzhang@yj-technology.com
 * @version $Id: EditTechAlterDetailsPurchaseConcatAction.java 2008-12-7 16:22:02 smzhang$
 */
public class EditTechAlterDetailsPurchaseConcatAction extends PrepareAction{
	...
	public EditTechAlterDetailsPurchaseConcatAction(PurchaseBillManager purchaseBillManager,
...
//		工装制作明细所关联的采购合同
	...
	public String save(){
    	...
    	//设置明细类别
    	this.purchaseBillDetail.setDetailType(YearPlanDetailCategory.TECH_ALTER);
