 ...
 */
public class ListSpareOutBillAction extends ValueListAction{
	...
	public ListSpareOutBillAction(SpareOutBillManager spareOutBillManager,
	                              DepartmentManager departmentManager,
	                              UserManager userManager,
	                              WarehouseManager warehouseManager,
	                              CodeValueManager codeValueManager,com.yongjun.tdms.service.asset.spare.warehouseInfo.warehouse.WarehouseManager  newwarehouseManager){
	    ...
	    if(size>0){
	    	 ...
	    	 if("208".equals(storageGrade)){
	 		 ...
	 		 if(!"".equals(outWarehouse)){
	 	 		...
	 	 		allTtotlePrice = this.spareOutBillManager.showOutTotalPrice(param);
