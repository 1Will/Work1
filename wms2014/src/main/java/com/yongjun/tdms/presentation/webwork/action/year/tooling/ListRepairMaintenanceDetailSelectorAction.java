...
/**
 * 
 * <p>Title: ListRepairMaintenanceDetailSelectorAction
 * <p>Description: 维修保养明细查询页面访问控制类</p>
 * <p>Copyright: Copyright (c) 2007 yj-technology</p>
 * <p>Company: www.yj-technology.com</p>
 * @author zbzhang@yj-technology.com
 * @version $Id:$
 */
public class ListRepairMaintenanceDetailSelectorAction extends ValueListAction {

	private static final long serialVersionUID = -8327304082227876395L;
	
	private final DepartmentManager departmentManager;
	private final ToolingTypeManager toolingTypeManager;
	
	public ListRepairMaintenanceDetailSelectorAction(DepartmentManager departmentManager,
	...
	protected String getAdapterName() {
		return "yearRepairMaintenanceDetailSelector";
	}
