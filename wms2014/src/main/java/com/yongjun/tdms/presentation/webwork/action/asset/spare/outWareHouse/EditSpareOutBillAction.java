 ...
 */
public class EditSpareOutBillAction extends PrepareAction{
	...
	public EditSpareOutBillAction(SpareOutBillManager spareOutBillManager,
	...
	public void prepare() throws Exception {
		...
		if(spareOutBill.getOldForNew()!=null&&spareOutBill.getOldForNew().getId()!=null){
			
			oldId =spareOutBill.getOldForNew().getId()+""; 
		}
	}
...
//		this.getLogger().logStore(spareOutBill,logContent);
		...
		if (isNew) {
			this.addActionMessage(this.getText("spareOutBill.add.success",
					Arrays.asList(new Object[] { spareOutBill.getCode() })));
			return NEW;
		} else {
			this.addActionMessage(this.getText("spareOutBill.edit.success",
					Arrays.asList(new Object[] { spareOutBill.getCode() })));
			return SUCCESS;
		}
	}
...
//		list.add(0, ware);		
	...
	public List<Warehouse> getAllOutWarehouse(){
		...
		//	list = this.warehouseManager.loadByKey("storageGrade", "209");
			...
			String[] values={"209","0","N"};
			String[] keys1={"storageGrade","disabled"};
			String[] values1={"208","0"};
			list = this.warehouseManager.loadByKeyArray(keys, values);
			list2 = this.warehouseManager.loadByKeyArray(keys1, values1);
