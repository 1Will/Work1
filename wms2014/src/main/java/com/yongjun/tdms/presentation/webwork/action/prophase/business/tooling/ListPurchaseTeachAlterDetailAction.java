 ...
 */
public class ListPurchaseTeachAlterDetailAction extends ValueListAction {	
	 ...
	 */
	public ListPurchaseTeachAlterDetailAction(SubscribeManager subscribeManager){
...
//		subscribeManager.updateToolingSubscribeStatus(subscribe,"REPAIR_MAINTENANCE");
	...
	/**
	 * 从季度计划的技术改造明细copy到采购单的技术改造明细
	 */
	public String saveAddQuarterPlanDetail() {
		this.subscribeManager.storToolingQuarterPlan(subscribe,addQuarterPlanDetailIds,"TECH_ALTER");
		return SUCCESS;
	}
	
	/**
	 * 判断页面是不是季度计划技术改造明细选择而来
	 * @return true | false
	 */
