...
/**
 * <p>Title:ListRepairMantanceDetailPurchaseConcatAction
 * <p>Description:采购合同维修保养明细列表页面控制类</P>
 * <p>Copyright:Copyright (c) 2008 yj-technology</P>
 * <p>Company:www.yj-technology.com</P>
 * @author yli@yj-technology.com
 * @version $Id: ListRepairMantanceDetailPurchaseConcatAction.java 2008-12-7 11:03:27 smzhang$
 */
public class ListRepairMantanceDetailPurchaseConcatAction extends
		ValueListAction {
...
private static final long serialVersionUID = 5498177256301105256L;
	 ...
	 */
	public ListRepairMantanceDetailPurchaseConcatAction(PurchaseBillManager purchaseBillManager,
	...
	public String saveAddPurchaseBill() {
		this.purchaseBillDetailManager.storeRepairMantancePurchaseDtl( purchaseBill,addNewPurchaseBillDetailIds);
		return SUCCESS;
	}
	/**
	...
	protected String getAdapterName() {
		return "repairMantanceDtlConcats";
	}
