 ...
 */
public class ListSpareInBillForOldToNewDetailAction extends ValueListAction {
	...
	private String allSpareInBillDtlName;				//入库单明细所有备件名称
	private String allSpareInBillDtlModel;				//入库单明细所有备件型号
	private String allSpareInBillDtlTaxPriceValue;     //入库单明细所有入库单价
	private String allSpareInBillDtlComment;			//入库单明细所有备注
	private String allDisableSpare;			//入库单明细所有是否可用
	...
	public ListSpareInBillForOldToNewDetailAction(SpareInBillManager spareInBillManager,
...
//        }
        //获取所有备件名称
        if(!StringUtils.isEmpty(request.getParameter("allSpareInBillDtlNameValue"))){
			this.allSpareInBillDtlName = request.getParameter("allSpareInBillDtlNameValue");
		}
      //获取所有备件型号
        if(!StringUtils.isEmpty(request.getParameter("allSpareInBillDtlModelValue"))){
			this.allSpareInBillDtlModel= request.getParameter("allSpareInBillDtlModelValue");
		}
		//获得所有入库单明细的入库数量
...
//		更新申购单、汇总单、采购单的入库项
	...
	public String saveOldSpareInBillDetail(){
		if(!StringUtils.isEmpty(request.getParameter("allSpareInBillDtlDisableValue"))){
			this.allDisableSpare = request.getParameter("allSpareInBillDtlDisableValue");
		}
		//获得所有入库单明细的ID
		if(!StringUtils.isEmpty(request.getParameter("allSpareInBillDtlIds"))){
			this.allSpareInBillDtlId = request.getParameter("allSpareInBillDtlIds");
...
//        }
      ...
      //获取所有备件型号
		...
		if(null!=roleWarehouseId || null!=allSpareInBillDtlComment||null!=allSpareInBillDtlNumber||null!=allSpareInBillDtlId||null!=allSpareInBillDeparement||null!=allLocationCodeValue||null!=allSpareInBillDtlModel||null!=allSpareInBillDtlName){
			this.spareInBillDetailManager.storeSpareInBillDtlForOldToNew(Long.parseLong(roleWarehouseId),allSpareInBillDtlComment,allSpareInBillDtlName,allSpareInBillDtlModel,allSpareInBillDtlNumber,allSpareInBillDtlId,allSpareInBillDeparement,allLocationCodeValue,allSpareInBillDtlTaxPriceValue,allDisableSpare);
		}
//		获得入库明细ID集合对应的采购明细ID集合
		String pruchDetailIds = this.spareInBillDetailManager.updPurchaseBillIds(allSpareInBillDtlId);
//		更新申购单、汇总单、采购单的入库项
