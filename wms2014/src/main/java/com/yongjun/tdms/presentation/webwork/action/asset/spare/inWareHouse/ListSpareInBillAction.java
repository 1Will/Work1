 ...
 * @version Id:
 */
public class ListSpareInBillAction extends ValueListAction {
	...
	public ListSpareInBillAction(SpareInBillManager spareInBillManager, 
...
//			System.out.println("inStatus: " + request.getParameter("inStatus"));
		...
		return this.spareInBillManager.showTotalPrice(info);
//		return null;
	}
