...
/**
 * 
 * <p>Title: ListToolingMakeDetailSelectorAction
 * <p>Description: 工装制作明细查询页面访问控制类</p>
 * <p>Copyright: Copyright (c) 2007 yj-technology</p>
 * <p>Company: www.yj-technology.com</p>
 * @author zbzhang@yj-technology.com
 * @version $Id:$
 */
public class ListToolingMakeDetailSelectorAction extends ValueListAction {
	private static final long serialVersionUID = 7016431760837429487L;
	
	private final DepartmentManager departmentManager;
	private final ToolingTypeManager toolingTypeManager;
	
	public ListToolingMakeDetailSelectorAction(DepartmentManager departmentManager,
	...
	protected String getAdapterName() {
		return "yearToolingMakeDetailSelector";
	}
