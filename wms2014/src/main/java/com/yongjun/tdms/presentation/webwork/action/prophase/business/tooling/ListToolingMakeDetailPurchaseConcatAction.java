...
/**
 * <p>Title:ListToolingMakeDetailPurchaseConcatAction
 * <p>Description:采购合同工装制作明细列表页面控制类</P>
 * <p>Copyright:Copyright (c) 2008 yj-technology</P>
 * <p>Company:www.yj-technology.com</P>
 * @author smzhangi@yj-technology.com
 * @version $Id: ListToolingMakeDetailPurchaseConcatAction.java 2008-12-7 11:03:27 smzhang$
 */
public class ListToolingMakeDetailPurchaseConcatAction extends ValueListAction {
	...
	private String valueAry;								  //页面信息
	/**
	 * 构造方法
	 * @param purchaseBillManager,
	 * 		  purchaseBillDetailManager
	 */
	public ListToolingMakeDetailPurchaseConcatAction(PurchaseBillManager purchaseBillManager,
	...
	public String saveAddPurchaseBill() {
		this.purchaseBillDetailManager.storPurchaseBillDtl( purchaseBill,addNewPurchaseBillDetailIds);
		return SUCCESS;
	}
	/**
	...
	protected String getAdapterName() {
		return "purToolingMakeDtlConcats";
	}
