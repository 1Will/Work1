...
/**
 * 
 * <p>Title: QuarterPlanDetail
 * <p>Description: 季度计划明细类</p>
 * <p>Copyright: Copyright (c) 2007 yj-technology</p>
 * <p>Company: www.yj-technology.com</p>
 * @author zbzhang@yj-technology.com
 * @version $Id: QuarterPlanDetail.java 27831 2010-10-14 09:13:41Z jyang $
 */
public class QuarterPlanDetail extends BaseInfoEntity {

	private static final long serialVersionUID = 825055098372735961L;
    ...
    //列入采购 true|false   true表示已列入 默认为未列入
	private boolean createPurchaseFlag = false;
	//备注
	...
	//关联的年度计划明细
	private YearPlanDetail yearPlanDetail;
	//计量单位[工装]
	...
	public boolean equals(Object o) {
		...
		if (o instanceof QuarterPlanDetail) {
			return true;
		}
		return false;
	}
	...
	public boolean isCreatePurchaseFlag() {
		return createPurchaseFlag;
	}

	public void setCreatePurchaseFlag(boolean createPurchaseFlag) {
		this.createPurchaseFlag = createPurchaseFlag;
	}

	public YearPlanDetail getYearPlanDetail() {
		return yearPlanDetail;
	}

	public void setYearPlanDetail(YearPlanDetail yearPlanDetail) {
		this.yearPlanDetail = yearPlanDetail;
	}
