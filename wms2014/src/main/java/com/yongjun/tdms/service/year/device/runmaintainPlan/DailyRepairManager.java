...
/**
 * 
 * <p>Title: DailyRepairManager
 * <p>Description: 运维计划的日常维修业务处理接口类</p>
...
public interface DailyRepairManager {
	/**
	 ...
	 */
	@Transactional
	void deleteAllDailyRepairs(RunmaintainPlanDetail runmaintainPlanDetail, Collection<DailyRepair> dailyRepairs);
}
