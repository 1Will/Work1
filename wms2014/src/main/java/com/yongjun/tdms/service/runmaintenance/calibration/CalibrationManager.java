...
/**
 * <p>Title: CalibrationManager
 * <p>Description: 工装标定业务接口定义类</p>
...
public interface CalibrationManager {
	...
	@Transactional
	void deleteAllCalibrations(Collection<Calibration> calibrations)throws Exception;
	 ...
	 */
	@Transactional
	void disabledAllCalibration(List<Calibration> calibrations)throws Exception;
	/**
	 * 有效
	 * @param calibrations
	 */
	@Transactional
	void enabledAllCalibration(List<Calibration> calibrations);
}
