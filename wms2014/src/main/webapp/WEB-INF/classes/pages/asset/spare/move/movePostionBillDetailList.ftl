...
window.onload=function(){
	...
	function retrieveMovePostionBillDetailNumberText(){
		...
		var allNumbers = "";
	  	...
	  	document.getElementById("allMovePostionDetailNumber").value=allNumbers;
	}
 	/* 判断是否输入了出存数量 */
