...
<script language="JavaScript" type="text/JavaScript">
	...
	function checkInvalidParms()
	{
		...
		//类型为所有，将类型的值置为空
		if (document.getElementById("toolDevFlag").value == -1) {
	  		document.getElementById("flag").value = '';
		}
		if(document.getElementById("toolDevFlag").value=='DEVICE'){
		   document.forms[0].elements["flag"].value='设备';
		}
		if(document.getElementById("toolDevFlag").value=='TOOLING'){
		   document.getElementById("flag").value = '工装';
		}
		//部门为所有，将部门的值置为空
