...
<@framePage title="">
	 <@ww.form name="'spare'" action="'searchSpareLocationToFrames'" method="'post'">
	   ...
	   <#assign spareModelTest='spareModel'+'${itemNo}'/>
        ...
        <@list title="${action.getText('备件匹配列表')}" 
			...
			<#--
			<#assign spareDetailTypeId='#{object.spare.spareDetailType.id}'/>
			-->
			<#assign unitId=''/>
			<#assign factoryId=''/>
			<#assign factoryName=''>
           ...
           <@vcolumn title="${action.getText('code')}" sortable="desc">
            ...
            <@vcolumn title="${action.getText('unit')}" property="spare.unit.value" sortable="desc">
             ...
             <@vcolumn title="${action.getText('库区')}" property="regional.name" sortable="desc">
            	<@alignLeft/>
            </@vcolumn>
     ...
     <script language="javascript">
           ...
           function returnSpareValueTest(ary,item){
              ...
              //设置品名
              parent.frames["topFrame"].document.forms[0].elements["spareInventoryDetail.name"].value=$(nameTag+parseInt(item)).innerText.Trim();
              //设置规格型号
              parent.frames["topFrame"].document.forms[0].elements["spareInventoryDetail.model"].value=$(modelTag+parseInt(item)).innerText.Trim();
              //设置种类
              if(arry[3] != '' && arry[3] != '-1'){
            ...
            //  }
             ...
             //  alert(arry[11]);
              ...
              parent.frames["topFrame"].document.forms[0].elements["regional.id"].value=arry[12]; 
               <#--库区级联库位--> 
               	DWREngine.setAsync(false); 
	    	    //回调种类的值后触发DWR 级联明细种类  
              ...
              parent.frames["topFrame"].document.forms[0].elements["location.id"].value=arry[13];   
