...
<script language="javascript">
	...
	*/
	function departmentValueChange(departmentId, productionLineId) {      
	  var selectedDepartmentId = document.getElementById(departmentId).value;
	...
	*/
	function createLineSelect(ary, productionLineId) {     
	  var obj = document.getElementById(productionLineId);
	...
	*/  	
	function deleteAllLines(departmentId, productionLineId) {     
      document.getElementById(productionLineId).value='';
	  var obj = document.getElementById(productionLineId);
