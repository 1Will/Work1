 ...
 var inStatusSelector = document.all("moveStatus");
  ...
  function checkInvalidParms(){
   if(document.forms[0].elements["MovePositionBillDate_start"].value!=""){
    ...
    if (document.getElementById("storageGrade.id").value == -1) {
	  document.getElementById("storageGrade.id").value = '';
	}
	if (document.getElementById("warehouse.id").value == -1) {
	  document.getElementById("warehouse.id").value = '';
	}
    if (document.getElementById("moveStatus").value == -1) {
	  document.getElementById("moveStatus").value = '';
	}
