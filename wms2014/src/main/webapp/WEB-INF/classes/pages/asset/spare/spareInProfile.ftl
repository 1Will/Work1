...
<@htmlPage title="${action.getText('sapreInBill.title')}">
  <style type="text/css">
	   ...
	   var billInfo=decodeURI("${billInfo?if_exists}");
	     if(billInfo!=""){
	        var ary=billInfo.split(",");
	         document.getElementById("spareInBill.billNo").value=ary[0];
	         document.getElementById("spareInBill.name").value=ary[1];
              document.getElementById("spareInBill.inoutDateTm").value=ary[2];
	           document.getElementById("spareInBill.inoutPeople").value=ary[3];
	            document.getElementById("spareInBill.comment").value=ary[4];
	        }
	}
	...
	function transformInStockValue(){
	  var ary=new Array();
	   ary.push(document.getElementById("spareInBill.billNo").value);
	   ary.push(document.getElementById("spareInBill.name").value);
       	ary.push(document.getElementById("spareInBill.inoutDateTm").value);
	         ary.push(document.getElementById("spareInBill.inoutPeople").value);
	            ary.push(document.getElementById("spareInBill.comment").value);
	              return ary;
	}
