...
<script language="javascript">
	window.onload=function(){
	    ...
	    <#else>
	       parent.document.getElementById("save").disabled=null;
	    </#if>
		//改变父页面的总金额
		<#if spareInventoryBill.id?exists>
            parent.document.getElementById("spareInventoryBill.totalPrice").value = '${spareInventoryBill.totalPrice?if_exists}';
        </#if>
