...
<@htmlPage title="${action.getText('lubricationRules.title')}">
 <base target="_self" />
	 ...
	 window.onload=function(){
	     var time=document.getElementById("lubricationRule.lastLubricationDate").value;
	      if(time==""){
	         time=new Date();
	         var currentTime=time.format("yyyy-MM-dd");
	         document.getElementById("lubricationRule.lastLubricationDate").value=currentTime;
	      }
	 }
