    ...
    function checkInvalidParms() {
	    ...
	    if (document.getElementById("status").value == -1) {
          document.getElementById("status").value = '';
            ...
            var startUsedDate = document.getElementById("usedAprDate_start").value;
            var endUsedDate = document.getElementById("usedAprDate_end").value;
	        ...
	        var startDate = document.getElementById("unUseDate_start").value;
        	var endDate = document.getElementById("unUseDate_end").value;
