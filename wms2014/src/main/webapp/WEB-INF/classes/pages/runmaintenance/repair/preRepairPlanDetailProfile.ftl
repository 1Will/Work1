 ...
 <base target="_self">
	 <@ww.form name="'preRepairPlanDetail'" action="'savePreRepairPlanDetail'" method="'post'" validate="true">
		 ...
		 */
		 ...
		 if(document.getElementById("preRepairPlanDetail.toolingName").value!=''){
		   if(!isValidLength(document.forms["preRepairPlanDetail"], "preRepairPlanDetail.toolingName", null, 50)){
			...
			if ('' == document.getElementById("preRepairPlanDetail.dutypeople").value) {
	       ...
	       if(document.getElementById("preRepairPlanDetail.planExecPeople").value!=''){
