	  	...
	  	window.onload = function() {
           ...
           <#if preRepairPlan.id?exists>
              if (document.forms[0].elements["planProcFlag"].value == 'PLAN') {
                parent.document.getElementById("preRepairPlan.planAllFee").value = '${preRepairPlan.planAllFee?if_exists}';
              } else {
                parent.document.getElementById("preRepairPlan.procAllFee").value = '${preRepairPlan.procAllFee?if_exists}';
                <#--
                parent.document.getElementById("preRepairPlan.procFinishStatus").value = '${preRepairPlan.procFinishStatus?if_exists}';
		        ...
		        parent.document.getElementById("preRepairPlan.procResult").value='${procStatus}';
		        -->
              }
            </#if>
          }
