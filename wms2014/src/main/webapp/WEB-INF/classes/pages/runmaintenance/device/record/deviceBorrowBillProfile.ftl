	    ...
	    <script language="JavaScript" type="text/JavaScript">
	      ...
	      */
	      function img_isDisplay(msg) {
	      	document.getElementById("repayPeopleImg").style.display=msg;
		  ...
		  function borrowReturnDateTmValidate() {
		    ...
		    if ('' != document.getElementById("toolingBorrowBill.checkDateTm").value) {
			   if (!isDate("toolingBorrowBill.checkDateTm")) {
			    ...
			    var date = $('toolingBorrowBill.checkDateTm').value;
		    ...
		    var date = $('toolingBorrowBill.inDateTm').value;
	        if (isDateLessThenCurrent(date)) {
	          alert("${action.getText('inDateTm.later.error')}");
	          return false;
	        }           
            var inDateTm = $('toolingBorrowBill.inDateTm').value;
              if (!inDateTmValidate()) {
                return false;
              }
            }
	       if($('produceNumSapn').style.display == 'inline'){
	       		if($('toolingBorrowBill.repayPeople').value == ''){
