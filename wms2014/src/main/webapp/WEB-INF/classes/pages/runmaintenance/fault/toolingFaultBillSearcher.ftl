...
<script language="javascript">
  document.getElementById("toolingDevFlag").value = 'TOOLING';
  ...
  function checkInvalidParms() {
	...
	if (document.getElementById("device.faultBillstatus").value == 'true') {
	  document.getElementById("solutionStatus").value = 'true';
	} else if (document.getElementById("device.faultBillstatus").value == 'false') {
	   document.getElementById("noSolutionStatus").value = 'false';
	}
	
	if (document.getElementById("device.faultBillType").value == 'FAULT') {
	  document.getElementById("faultBillType_fault").value = 'FAULT';
	} else if (document.getElementById("device.faultBillType").value == 'ACCIDENT') {
	   document.getElementById("faultBillType_accident").value = 'ACCIDENT';
	}
