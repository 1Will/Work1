    ...
    window.onload = function() {
      <#if migrate.id?exists>
        ...
        <#if migrate.oldDepartment?exists>
         document.getElementById("oldDepartment.id").value = #{migrate.oldDepartment.id};
        </#if>
        <#if loginUser.department?exists>
         document.getElementById("requestDepartment.id").value = #{loginUser.department.id};
        </#if>
        <#if migrate.newDepartment?exists>
         document.getElementById("newDepartment.id").value = #{migrate.newDepartment.id};
        </#if>
        <#if migrate.oldProductionLine?exists>
         document.getElementById("oldProductionLine.id").value = #{migrate.oldProductionLine.id};
        </#if>
        <#if migrate.newProductionLine?exists>
         document.getElementById("newProductionLine.id").value = #{migrate.newProductionLine.id};
        </#if>
        <#if migrate.requestDepartment?exists>
         document.getElementById("requestDepartment.id").value = #{migrate.requestDepartment.id};
        </#if>
        /**
     ...
     function migrate_Vlidate(){
       if(document.getElementById("migrate.billName").value==''){
      ...
      if(document.getElementById("migrate.requestDate").value==''){
	        alert('${action.getText('migrateDate.not.null')}');
	        return false;
	      }
	    var date=document.getElementById("migrate.requestDate").value;
		...
		if(document.getElementById("requester.name").value==''){
	        alert('${action.getText('requester.name.not.null')}');
	        return false;
	       }
	    if(document.getElementById("migrate.migrateReason").value!=''){
