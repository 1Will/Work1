  ...
  <script language="JavaScript" type="text/JavaScript">
     window.onload = function() {
       <#if intactnessBill.department?exists>
	     document.getElementById("department.id").value = #{intactnessBill.department.id};
	   ...
	   <#if intactnessBill.id?exists>
		 ...
		 document.getElementById("intactnessDetail").className = "selectedtab";
	   <#else>
	     a = new Date();
     ...
     */
	 ...
	 function validate() {
	   if(document.getElementById("intactnessBill.name").value=='') {
	   ...
	   if(document.getElementById("intactnessPeople.name").value=='') {
	      alert('${action.getText('select.intactnessPeople.name')}');
	      return false;
	   }
	   if(document.getElementById("intactnessBill.examDate").value=='') {
      ...
      if(document.getElementById("intactnessBill.comment").value!=''){
