...
<#--
  ...
  function checkInvalidParms() {
    var startDate = document.getElementById("planCompleteTime_start").value;
    var endDate = document.getElementById("planCompleteTime_end").value;
	...
	-->
	if (document.getElementById("tooling.changeBillStatus").value == 'true') {
	  document.getElementById("changingStatus").value = 'true';
	} else if (document.getElementById("tooling.changeBillStatus").value == 'false') {
	   document.getElementById("changedStatus").value = 'false';
	}
