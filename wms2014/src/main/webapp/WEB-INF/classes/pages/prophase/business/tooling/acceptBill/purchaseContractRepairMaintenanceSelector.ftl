...
<base target="_self">
<@htmlPage title="${action.getText('RepairMaintenanceDetail')}">
  <@ww.form  name="'listQuarterPlanChoose'" action="'searchPurchaseContractDtlOfRepairMaintenance'" method="'post'">
