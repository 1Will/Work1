...
<base target="_self">
<@htmlPage title="${action.getText('toolingMakeDetail')}">
  <@ww.form  name="'listQuarterPlanChoose'" action="'searchPurchaseContract'" method="'post'">
	...
	<#include "purchaseContractSelectorSeacher.ftl"/>
 	...
 	<@list title="" excel=false setupTable=false
           includeParameters="id|acceptId|detailType|billNo|name|department.id|category.id|graphNo|productName|model|specification|purchaseDate_start|purchaseDate_end" 
           fieldMap="like:id|billNo|name|graphNo|productName|model|specification|,date:purchaseDate_start|purchaseDate_end" >
      ...
      <@vcolumn title="${action.getText('department_sub')}" property="department">
        <@alignLeft/>
      </@vcolumn>
