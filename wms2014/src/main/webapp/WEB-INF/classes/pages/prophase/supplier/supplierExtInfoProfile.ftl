...
<@inputTable>
  ...
  <script language="javascript">
     ...
     if(document.getElementById("supplierExtInfo.contact0").value!='')	{	  	
       if(!isValidLength(document.forms[0], "supplierExtInfo.contact0", null, 50)){
			alert("${action.getText('supplierExtInfo.contact0.length')}");
			return  false;
			   }	
	}  
	 if(document.getElementById("supplierExtInfo.commercialInstrument").value!=''){
	  	...
	  	if(document.getElementById("supplierExtInfo.businessVariety").value!=''){
		...
		if(document.getElementById("supplierExtInfo.saleSupport").value!=''){
		...
		if(document.getElementById("supplierExtInfo.supportQos").value!=''){
