  ...
  <script language="javascript">
    window.onload = function() {
      <#if supplierEvaluate.level?exists>
       parent.document.getElementById("level.id").value = '${supplierEvaluate.level.value?if_exists}';
     </#if>
       parent.document.getElementById("evaluateMinute").value = '${supplierEvaluate.evaluateMinute?if_exists}';
  }
      function customize_validate(){
     
        var designGrade = document.getElementById("designGrade").value; 
        if (''!=designGrade) {
        ...
        if(document.getElementById("designComment").value!=''){
			if(!isValidLength(document.forms[0], "designComment", null, 250)){
				alert("${action.getText('designComment.length')}");
				return  false;
		    }
		}
        var makeGrade = document.getElementById("makeGrade").value; 
        if ('' != makeGrade) {
        ...
        if(document.getElementById("makeComment").value!=''){
       ...
       var QaGrade = document.getElementById("QaGrade").value; 
        if ('' != QaGrade) {
         ...
         if(document.getElementById("QaComent").value!=''){
			if(!isValidLength(document.forms[0], "QaComent", null, 250)){
				alert("${action.getText('QaComent.length')}");
				return  false;
			   }
			}
        var seviceGrade = document.getElementById("seviceGrade").value; 
        if ('' != seviceGrade) {
        ...
        if(document.getElementById("seviceComent").value!=''){
			if(!isValidLength(document.forms[0], "seviceComent", null, 250)){
				alert("${action.getText('seviceComent.length')}");
				return  false;
			   }
			}
        var basicControlgrade = document.getElementById("basicControlgrade").value; 
        if ('' != basicControlgrade) {
         ...
         if(document.getElementById("basicControlComent").value!=''){
      ...
      function retrieveAllGradeAndComment(idName, gradeName, commentName,hiddenAllValueName) {
        ...
        var gradeValue = document.getElementById(gradeName).value;
        var commentValue = document.getElementById(commentName).value;
        ...
        document.getElementById(hiddenAllValueName).value = ary;
      }
      </script>
</@framePage>
