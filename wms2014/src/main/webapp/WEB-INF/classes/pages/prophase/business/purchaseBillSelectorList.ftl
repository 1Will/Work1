...
<base target="_self">
<@ww.form namespace="'/accept'" name="'listForm'" action="'listPurchaseBillSelector'" method="'post'">
 ...
 <@list title="" excel=false setupTable=false
		...
		fieldMap="like:billNo|name|name1|model|specification,date:purchaseDate_start|purchaseDate_end">
           ...
           <#if object.purchaseBill?exists>
            ...
            <@vcolumn title="${action.getText('purchaseBill.billNo')}" property="billNo">
            ...
            <@vcolumn title="${action.getText('purchaseBill.name')}" property="purchaseBill.name">
            	<@alignLeft />
            </@vcolumn>
