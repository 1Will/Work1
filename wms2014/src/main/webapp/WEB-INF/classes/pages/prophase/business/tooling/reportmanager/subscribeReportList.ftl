...
<script language="JavaScript" type="text/JavaScript">
       ...
       function open_subscribePdf(){
	       ...
	       var url='${req.contextPath}/reports/subscribe/subscribeDetailMonthView.pdf?date_start='+$("subscribeDate_start").value+"&date_end="+$("subscribeDate_end").value+"&department.id="+dept+"&subIds="+subIds;  
           url = encodeURI(url);
	   ...
	   function open_subscribeXls(){
	       ...
	       var url='${req.contextPath}/reports/subscribe/subscribeDetailMonthView.xls?date_start='+$("subscribeDate_start").value+"&date_end="+$("subscribeDate_end").value+"&department.id="+dept+"&subIds="+subIds; 
           url = encodeURI(url);
           window.open(url,"_new","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=screen.width,height=screen.height,left=0,top=0"); 
	   }   
