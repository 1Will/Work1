...
<base target="_self">
	<@ww.form namespace="'/toooling/purchaseContract'" name="'listForm'" action="'saveTechAlterDetailsPurchaseConcat'" method="'post'">
		<@ww.token name="saveTechAlterDetailsPurchaseConcatToken"/>
	   ...
	   <@buttonBar>
       <@vsubmit name="'save'" value="'${action.getText('save')}'" onclick="'return validateTechAlter()'">
       </@vsubmit>
