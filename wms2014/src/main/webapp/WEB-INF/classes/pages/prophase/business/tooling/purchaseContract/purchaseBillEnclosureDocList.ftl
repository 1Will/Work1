	...
	<@ww.form name="'listForm'" action="'searchPurchaseEnclosure'" method="'post'">
        ...
        <@buttonBar>
        	...
        	<#if !(action.isReadOnly())>
        	 <@buttonBar>
	         	<#assign confirmMessage = "${action.getText('confirm.delete')}${action.getText('purchaseBillchangeDocCON')}?" />
	 ...
	 <script language="javascript">
	    	...
	    	function open_uploadDialog(purchaseBillId, purchaseBillDocId) {
	    		...
	    		if (null == purchaseBillDocId) {
	    			// url = '${req.contextPath}/prophase/editPurchaseEnclosureDoc.html?purchaseBill.id='+purchaseBillId;
	    			url = '${req.contextPath}/toooling/purchaseContract/editPurchaseEnclosureDoc.html?purchaseBill.id='+purchaseBillId;
	    			
	    		} else {
	    			 //url = '${req.contextPath}/prophase/editPurchaseEnclosureDoc.html?purchaseBill.id='+purchaseBillId+ '&purchaseEnclosureDoc.id=' + purchaseBillDocId;
	    			 url = '${req.contextPath}/toooling/purchaseContract/editPurchaseEnclosureDoc.html?purchaseBill.id='+purchaseBillId+ '&purchaseEnclosureDoc.id=' + purchaseBillDocId;
