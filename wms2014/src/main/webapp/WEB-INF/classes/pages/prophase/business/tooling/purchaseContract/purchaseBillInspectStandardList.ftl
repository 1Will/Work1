...
<@framePage title="${action.getText('payDetails.title')}">	
	...
	<@ww.form name="'listForm'" action="'searchInspectStandard'" method="'post'">
        ...
        <@buttonBar>
            ...
            <#assign confirmMessage = "${action.getText('confirm.delete')}${action.getText('toolinginspectStandard')}?" />
            ...
            <script language="javascript">
            	function open_payDtlDialog(purchaseBillId,inspectDtlId) {
            		var url = '${req.contextPath}/prophase/editInspectStandard.html?purchaseBill.id=' + purchaseBillId;
