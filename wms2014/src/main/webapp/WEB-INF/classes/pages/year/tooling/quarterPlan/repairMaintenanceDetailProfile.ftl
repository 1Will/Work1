...
<@htmlPage title="${action.getText('repairMaintenanceDetailProfile.title')}">
 <base target="_self">
   <@ww.form namespace="'/popup'" name="'repairMaintenanceDetail'" action="'saveQuarterRepairMaintenanceDetail'" method="'post'" validate="true">
     <@ww.token name="saveQuarterRepairMaintenanceDetailToken"/>
     ...
     <@inputTable>
	   ...
	   <tr>
       <tr>
    	 <@ww.textfield label="'${action.getText('allPrice')}'" name="'repairMaintenanceDetail.allPrice'" value="'${(repairMaintenanceDetail.allPrice?string('#,###,##0.00'))?if_exists}'" cssClass="'underline'" disabled="false"/>
