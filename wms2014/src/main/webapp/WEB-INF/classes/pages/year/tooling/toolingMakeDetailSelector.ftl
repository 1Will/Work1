...
<base target="_self">
  <@ww.form name="'listYearPlan'" action="'toolingMakeDetailSelector'" method="'post'">
    ...
    <#assign itemNo = 1/>
 	<@list title="${action.getText('toolingMakeDetail.list')}" 
           includeParameters="planNo|planName|department.id|year|category.id|planFinishedDate_start|planFinishedDate_end" 
