...
<@htmlPage title="清洗计划维护">

<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='listWashItems.html';
	...
	function userSelectorHandler(result) {
	 ...
	 <@ww.form name="'accident'" action="'searchProducts'" method="'post'" validate="true">
	 	  ...
	 	  <@buttonBar>
	        	...
	        	<@redirectButton  value="返回" url="listWashPlans.html"/>
	     </@buttonBar>
	</@ww.form>
	
	<ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="listWashItems.html" target="frame" class="selectedtab">清洗明细</a></li>	
	</ul>
