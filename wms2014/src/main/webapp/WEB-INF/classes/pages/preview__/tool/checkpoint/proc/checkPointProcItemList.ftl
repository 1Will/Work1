		...
		<@ww.select label="'点检日期(周)'"
	      ...
	      />
			...
			<tr>
				...
				<#list ["1", "2", "3", "4", "5", "6", "7"] as x>	  	
            	<td>
            		<input type="text" size="10" class="underline" value="正常"/>
            	</td>
            	</#list>
			</tr>
			<tr>
			...
			<tr>
				...
				<#list ["1", "2", "3", "4", "5", "6", "7"] as x>	  	
            	<td><#if "${x}" == "1" >
            		<input type="text" size="10" class="underline" value="故障"/>
            		<#else>
            		<input type="text" size="10" class="underline" value="正常"/>
            		</#if>
            	</td>
			...
			<tr >
				...
				<#list ["1", "2", "3", "4", "5", "6", "7"] as x>	  	
            	<td><#if "${x}" == "1" >
            		<input type="text" size="10" class="underline" value="20" value="4" style="text-align:right"/>
            		<#else>
            		<input type="text" size="10" class="underline" />
            		</#if>
            	</td>
            	</#list>
			</tr>
			<tr>
				...
				<#list ["1", "2", "3", "4", "5", "6", "7"] as x>	  	
            	<td><#if "${x}" == "1" >
            		<input type="text" size="10" class="underline" value="4" value="4" style="text-align:right"/>
            		<#else>
            		<input type="text" size="10" class="underline" />
            		</#if>
            	</td>
			...
			<tr>
				...
				<#list ["1", "2", "3", "4", "5", "6", "7"] as x>	  	
            	<td><#if "${x}" == "1" >
            		<input type="text" size="10" class="underline" value="4" style="text-align:right"/>
            		<#else>
            		<input type="text" size="10" class="underline" />
            		</#if>
            	</td>
			...
			<tr>
				...
				<#list ["1", "2", "3", "4", "5", "6", "7"] as x>	  	
            	<td><#if "${x}" == "1" >
            		<input type="text" size="10" class="underline" value="system"/>
            		<#else>
            		<input type="text" size="10" class="underline" />
            		</#if>
            	</td>
			...
			<tr>
				...
				<#list ["1", "2", "3", "4", "5", "6", "7"] as x>	  	
            	<td><#if "${x}" == "1" >
            		<input type="text" size="10" class="underline" value="维修安全制动器"/>
            		<#else>
            		<input type="text" size="10" class="underline" />
            		</#if>
            	</td>
