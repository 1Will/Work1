...
<@htmlPage title="设备转移维护">
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='${req.contextPath}/preview/device/migrate/migrateDeviceList.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'">
        ...
        <@inputTable>
         ...
         <@buttonBar>
       		...
       		<@redirectButton value="返回" url="${req.contextPath}/preview/device/migrate/listMigrate.html"/>
    ...
    <ul id="beautytab">
		<li>
		<a id="MigrateList" onclick="activeTab(this);" class="selectedtab" href="${req.contextPath}/preview/device/migrate/migrateDeviceList.html" target="frame" >设备转移明细</a>
		</li>	
	</ul>
