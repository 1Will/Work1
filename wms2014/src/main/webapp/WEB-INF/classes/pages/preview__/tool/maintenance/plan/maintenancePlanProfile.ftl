...
<@htmlPage title="保养计划维护 ">

<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='listMaintenancePlanDetail.html';
    ...
    <@ww.form namespace="'/base/area'" name="'preRepairRule'" action="''" method="'post'" validate="true">
        <@ww.token name="saveAreaToken"/>
         <@buttonBar>
        	<input type="button" class="button" name="selectRule" value="选择保养标准" onclick="checkPointRule_openDialog()" />
    	</@buttonBar>
        <@inputTable>
        	<tr>
        		<@ww.textfield label="'保养计划编号'" name="'area.code'" value="'jac-wx-025'" cssClass="'underline'" disabled="true" readonly="true" />
	 	  	  	<@ww.textfield label="'保养计划名称'" name="'area.code'" value="" cssClass="'underline'" required="true" />
        	</tr>
        	<tr>
        		<@ww.textfield label="'保养标准编号'" name="'area.code'" value="'jac-wx-025'" cssClass="'underline'" disabled="true" required="true" readonly="true" />
	 	  	  	<@ww.textfield label="'保养标准名称'" name="'area.code'" value="" cssClass="'underline'" disabled="true"/>
        	</tr>
        	<@toolingSelector/>
            <tr>
		 	...
		 	<tr>
		 		<@ww.textfield label="'保养周期（天）'" name="'cycle'" value="" cssClass="'underline'" required="true" />
		 		<@ww.textfield label="'保养部门'" name="'cycle'" value="" cssClass="'underline'" required="true" />
            </tr>
            <tr>
            	<@pp.datePicker label="'计划开始日期'" name="'plan.start.date'"
	     			value="" cssClass="'underline'" size="15" required="true"/>
	     		<@pp.datePicker label="'计划完成日期'" name="'plan.end.date'"
	     			value="" cssClass="'underline'" size="15" required="true"/>
            </tr>
            <tr>  
       	...
       	<@buttonBar>
        	...
        	<@redirectButton value="${action.getText('back')}" url="listMaintenancePlan.html"/>	
        </@buttonBar>
    </@ww.form>
    
    <ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="listMaintenancePlanDetail.html" target="frame" class="selectedtab">保养计划明细</a></li>	
	</ul>
