...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='listCalibrationProcItems.html';
	...
	function userSelectorHandler(result) {
	 ...
	 <@ww.form name="'accident'" action="'searchProducts'" method="'post'" validate="true">
	 	  ...
	 	  <@inputTable>
		 	  ...
		 	  <tr>
		 	  	<@ww.textfield label="'报告人'" name="'area.code'" value="" cssClass="'underline'" required="true" />
		 	  	<@pp.datePicker label="'报告日期'" name="'err.date'"
	     				value="" cssClass="'underline'" size="15" required="true"/>	     		
		 	  </tr>		 	  
        </@inputTable>
	 	  ...
	 	  <@buttonBar>
	        	...
	        	<@redirectButton  value="返回" url="listCalibrationProcs.html"/>
	     </@buttonBar>
	</@ww.form>
	
	<ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="listCalibrationProcItems.html" target="frame" class="selectedtab">标定明细</a></li>	
	</ul>
