	...
	function userUnSealedSelectorHandler(result) {
	 ...
	 <ul id="beautytab">	 
	 	<#if !req.getParameter("proc")?exists>
	 		<li><a id="preRepairItemDetails" onclick="activeTab(this)" href="../../device/repair/listPreRepairPlanItemDetails.html" target="frame">维修明细</a></li>
		...
		<#else>
			<li><a id="preRepairItemDetails" onclick="activeTab(this)" href="../../device/repair/listPreRepairPlanItemDetails.html?proc=1" target="frame">维修明细</a></li>
