...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src="../../device/repair/listRepairPlanSpare.html?proc=1";
 		document.getElementById("preRepairSpareItems").className = "selectedtab";
 	}
	...
	function activeTab(obj) {
	 ...
	 <@ww.form name="'listForm'" action="'searchProducts'" method="'post'">
	 	<@inputTable>
	 		<@deviceSelector/>
	 		<tr>
	 			<@ww.textfield label="'维修部位'" name="'area.code'" value=""  cssClass="'underline'" readonly="true"/>
	 			<@ww.textfield label="'维修内容摘要'" name="'area.code'" value="" size="50" cssClass="'underline'" readonly="true"/>
	 		</tr>
	 		<tr>
	 			<@ww.textfield label="'责任单位'" name="'area.code'" value="" cssClass="'underline'"  readonly="true"/>
	 			<@ww.textfield label="'责任人'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
	 		</tr>
	 		<tr>
	 			<@ww.textfield label="'执行人'" name="'area.code'" value=""  cssClass="'underline'"  readonly="true"/>
	 ...
	 <ul id="beautytab">	 
			<li><a id="preRepairSpareItems" onclick="activeTab(this)" href="../../device/repair/listRepairPlanSpare.html?proc=1" target="frame">备件明细</a></li>	 
			<li><a id="preRepairRuleFee" onclick="activeTab(this)" href="../../device/repair/listPreRepairRuleFee.html?proc=1" target="frame" >费用明细</a></li>	  
			<li><a id="preRepairRuleManHour" onclick="activeTab(this)" href="../../device/repair/listPreRepairRuleManHour.html?proc=1" target="frame" >工时明细</a></li>	  
		<#--
