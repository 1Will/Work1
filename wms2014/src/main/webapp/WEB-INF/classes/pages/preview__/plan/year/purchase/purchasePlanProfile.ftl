...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../../plan/year/purchase/listPurchasePlanItems.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
            <tr>
                <@ww.textfield label="'采购计划编号'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="false"/>
	       ...
	       <tr>
	          <@ww.textfield label="'计划总费用(元)'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="false"/>
	          <@ww.textfield label="'发生总费用(元)'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="false"/>
            </tr>
            <tr>
       	...
       	<@buttonBar>
       		<@redirectButton value="${action.getText('save')}" url="${req.contextPath}/preview/plan/year/purchase/listPurchasePlans.html"/>	
        	<@redirectButton value="打印" url="#"/>	
        	<@redirectButton value="${action.getText('back')}" url="${req.contextPath}/preview/plan/year/purchase/listPurchasePlans.html"/>	
        </@buttonBar>
    </@ww.form>
    
    
	<ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="../../../plan/year/purchase/listPurchasePlanItems.html" target="frame" >采购计划明细</a></li>	    		  
		<li><a id="impls" onclick="activeTab(this);"  href="../../../plan/year/purchase/listPurchasePlanImpls.html" target="frame" >发生详细</a></li>	    		  
	</ul>
