...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../device/discard/listDiscardPlanItems.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
            ...
            <tr>
            	<@ww.textfield label="'报废日期'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
            	<@ww.textfield label="'备注'" name="'area.code'" size="50" value="" cssClass="'underline'" readonly="true"/>
            </tr>     
        </@inputTable>
       	<@buttonBar>
       		<@redirectButton value="${action.getText('save')}" url="${req.contextPath}/device/discard/listDiscards.html"/>	
        	<@redirectButton value="${action.getText('back')}" url="${req.contextPath}/device/discard/listDiscards.html"/>	
        </@buttonBar>
    </@ww.form>
	...
	<ul id="beautytab">
	    	<li><a id="planItems" href="../../device/discard/listDiscardPlanItems.html" target="frame" class="selectedtab">报废项目明细</a></li>	    		  
	</ul>
