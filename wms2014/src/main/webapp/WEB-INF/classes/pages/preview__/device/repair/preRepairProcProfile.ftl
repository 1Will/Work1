...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../device/repair/listPreRepairProcItems.html?proc=1';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
        	<tr>
                <@ww.textfield label="'预防性维修计划编号'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="true"/>
                <@ww.textfield label="'预防性维修计划名称'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="true"/>
            </tr>
			<tr>
                <@ww.textfield label="'计划制定人'" name="'area.code'" value="" cssClass="'underline'" />
                <@ww.textfield label="'计划审核人'" name="'area.code'" value="" cssClass="'underline'" />
            </tr>
        </@inputTable>
       	<@buttonBar>
    ...
    <ul id="beautytab">
		<li><a id="preRepairItems" onclick="activeTab(this)" href="../../device/repair/listPreRepairProcItems.html" target="frame" class="selectedtab">预防维修实施明细</a></li>	    		  
		<#--
