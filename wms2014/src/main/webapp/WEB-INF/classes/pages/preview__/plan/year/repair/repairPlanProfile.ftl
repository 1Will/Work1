...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../../plan/year/repair/listRepairPlanItems.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
            <tr>
                <@ww.textfield label="'大项修计划编号'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="true"/>
                <@ww.textfield label="'大项修计划名称'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="true"/>
            </tr>
            <tr>
            	 <@pp.datePicker label="'计划建立时间'" name="'repair.estimate.time0'"
	     			value="" cssClass="'underline'" size="15" required="true"/>
                <@ww.textfield label="'计划制作人'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="true"/>
            </tr>
            <tr>
               <@ww.select label="'年度'"
	                    	name="device"
	...
	<ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="../../../plan/year/repair/listRepairPlanItems.html" target="frame" class="selectedtab">大项修计划明细</a></li>	
		<#--
