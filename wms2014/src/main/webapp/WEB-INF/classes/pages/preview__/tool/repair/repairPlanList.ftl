	 ...
	 <@ww.form name="'listForm'" action="'searchProducts'" method="'post'">
        ...
        <@buttonBar>
			...
			<tr>
				...
				<td style="text-align:left"><a href="${req.contextPath}/preview/tool/repair/editRepairPlan.html">20080809110401000</a></td>
			...
			<tr>
	     	 ...
	     	 <@buttonBar>
	    		<@redirectButton value="${action.getText('new')}" url="${req.contextPath}/preview/tool/repair/editRepairPlan.html"/>
