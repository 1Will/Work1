...
<script language="JavaScript" type="text/JavaScript"> 
	...
	<script language="JavaScript" type="text/JavaScript"> 
		function setcity() { 
				...
				document.getElementById("cate").innerText="模具分类:"
				...
				document.getElementById("cate").innerText="夹具分类:"
				break;
				...
				var values = new Array("jn","qd","yt"); 
				//document.getElementsByTagName("label").text="夹具类别";
				document.getElementById("cate").innerText="分类:"
				break;
				...
				//document.getElementsByTagName("label").text="夹具类别";
				document.getElementById("cate").innerText="工位器具分类:"
				break;
				...
				var values = new Array(""); 
				//document.getElementsByTagName("label").text="夹具类别";
				document.getElementById("cate").innerText="检具分类:"
				break;
				...
				var values = new Array(""); 
				//document.getElementsByTagName("label").text="夹具类别";
				document.getElementById("cate").innerText="辅具分类:"
				break;
