...
<@htmlPage title="预防性维修计划维护 ">

<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='listPreRepairPlanDetail.html';
    ...
    <@ww.form namespace="'/base/area'" name="'preRepairRule'" action="''" method="'post'" validate="true">
        <@ww.token name="saveAreaToken"/>
         <@buttonBar>
        	<input type="button" class="button" name="selectRule" value="选择维修标准" onclick="checkPointRule_openDialog()" />
    	</@buttonBar>
        <@inputTable>
        	<tr>
        		<@ww.textfield label="'维修计划编号'" name="'area.code'" value="'jac-wx-025'" cssClass="'underline'" disabled="true" readonly="true" />
	 	  	  	<@ww.textfield label="'维修计划名称'" name="'area.code'" value="" cssClass="'underline'" required="true" />
        	</tr>
        	<tr>
        		<@ww.textfield label="'维修标准编号'" name="'area.code'" value="'jac-wx-025'" cssClass="'underline'" disabled="true" required="true" readonly="true" />
	 	  	  	<@ww.textfield label="'维修标准名称'" name="'area.code'" value="" cssClass="'underline'" disabled="true"/>
        	</tr>
        	<@toolingSelector/>
            <tr>
		 	...
		 	<tr>
		 		...
		 		<@ww.textfield label="'维修部门'" name="'cycle'" value="" cssClass="'underline'" required="true" />
            </tr>
            <tr>
    ...
    <ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="listPreRepairPlanDetail.html" target="frame" class="selectedtab">维修计划明细</a></li>	
	</ul>
