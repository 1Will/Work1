...
<@htmlPage title=" 保养标准维护 ">

<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='listMaintenanceRuleDetail.html';
    ...
    <@ww.form namespace="'/base/area'" name="'preRepairRule'" action="''" method="'post'" validate="true">
        ...
        <@inputTable>
        	<tr>
        		<@ww.textfield label="'保养标准编号'" name="'area.code'" value="'jac-wx-025'" cssClass="'underline'" disabled="true" readonly="true" />
	 	  	  	<@ww.textfield label="'保养标准名称'" name="'area.code'" value="" cssClass="'underline'" required="true" />
        	</tr>
        	<@toolingSelector/>
            <tr>
       	...
       	<@buttonBar>
        	...
        	<@redirectButton value="${action.getText('back')}" url="listMaintenanceRule.html"/>	
        </@buttonBar>
    </@ww.form>
    
    <ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="listMaintenanceRuleDetail.html" target="frame" class="selectedtab">保养标准明细</a></li>	
	</ul>
