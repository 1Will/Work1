...
<@htmlPage title="工装备件维护">
	<script language="JavaScript" type="text/JavaScript"> 
	 ...
	 <@ww.form name="'listForm'" action="'searchProducts'" method="'post'" validate="true">
	 	  ...
	 	  <@inputTable>
	 	  	<tr>
	 	  	<td align="right" valign="top"><label class="label">备件名称:</label></td>
	        	<td>
	        		<input type="text" name="shipmentPlan.vehicle.code" 
	        			class="underline"  value=""  maxlength="150" size="20" disabled>
	        		<label id=""></label>
	 	  		...
	 	  		<@ww.textfield label="'备件型号'" name="'area.code'" value="" cssClass="'underline'" required="false" disabled="true"/>
	 	  	</tr>
	 	  	<tr>
	 	  		<@ww.textfield label="'所需个数'" name="'area.code'" value="" cssClass="'underline'" required="false" />
	 	  		<@ww.textfield label="'单价(元)'" name="'area.code'" value="" cssClass="'underline'" required="false" disabled="true"/>
	 	  	</tr>
	 	  	<tr>
	        	...
	        	<td>
	 	  		...
	 	  		<@ww.textfield label="'当前库存'" name="'area.code'" value="100" cssClass="'underline'" size="40" readonly="true" disabled="true"/>
	 	  	</tr>
