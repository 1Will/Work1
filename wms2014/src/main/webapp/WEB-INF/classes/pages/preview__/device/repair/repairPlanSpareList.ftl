	 ...
	 <@ww.form name="'listForm'" action="'searchProducts'" method="'post'">
	 	<table width="100%" border="0" cellspacing="2" cellpadding="0" class="w01_11px_grey">
			...
			<tr>
				...
				<td style="text-align:right"><a href="#" onclick="popupModalDialog('${req.contextPath}/popup/editRepairSpares.html',750,400);return false;">1</a></td>
			...
			<tr>
				<td><input type="checkbox" name="checkbox" value="true"></td>
				<td style="text-align:right"><a href="#" onclick="popupModalDialog('${req.contextPath}/popup/editRepairSpares.html',750,400);return false;">2</a></td>
				<td style="text-align:right">07010102-02</td>
				<td style="text-align:left">机床轴承</td>
