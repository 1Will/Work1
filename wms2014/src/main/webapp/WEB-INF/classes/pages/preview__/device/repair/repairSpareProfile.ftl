...
<script language="JavaScript" type="text/JavaScript"> 
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="">
        ...
        <@inputTable>
       	...
       	<@buttonBar>
       		<input type="button" value="保存" class="button" onclick="warnSpareIsNotEnough();"/>		
        	<input type="button" value="关闭" class="button" onclick="window.close();"
        </@buttonBar>
    </@ww.form>
    
      <script>
        	function warnSpareIsNotEnough() {
        	
//        		alert("所选备件数不足，需要申购");
//        			window.location = "${req.contextPath}/asset/device/listDevices.html";
//        		}
        	}
