...
<script language="JavaScript" type="text/JavaScript"> 
	...
	function device_OpenDialog() {
	 ...
	 <@ww.form name="'listForm'" action="'searchProducts'" method="'post'" validate="true">
	 	  ...
	 	  <@inputTable>
	 	  	 <tr>
	 	  	  	<@ww.textfield label="'事故记录编号'" name="'area.code'" value="'0001'" cssClass="'underline'" disabled="true" readonly="true" />
	 	  	  	<@ww.textfield label="'事故记录名称'" name="'area.code'" value="" cssClass="'underline'" required="true" />
	 	  	  </tr>
	 	  	  <@deviceSelector/>			 	 	 	 
		 	  <tr>
		 	  	<@pp.datePicker label="'事故开始时间'" name="'repair.estimate.time0'"
	     				value="" cssClass="'underline'" size="15" required="true"/>
	     		<@pp.datePicker label="'事故结束时间'" name="'repair.estimate.time0'"
	     				value="" cssClass="'underline'" size="15" required="true"/>
		 	  </tr>
		 	  <tr>
		 	  	<@ww.textfield label="'事故原因'" size="50" name="'area.code'" value="" cssClass="'underline'" required="true" />
