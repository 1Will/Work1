...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../device/repair/listPreRepairPlanItems.html';
    ...
    <ul id="beautytab">
		<li><a id="preRepairItems" onclick="activeTab(this)" href="../../device/repair/listPreRepairPlanItems.html" target="frame" class="selectedtab">预防维修计划明细</a></li>	    		  
		<#--
