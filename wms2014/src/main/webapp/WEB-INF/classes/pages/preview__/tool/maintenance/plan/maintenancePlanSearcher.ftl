<@inputTable>
	 		<tr>
	 			<@ww.textfield label="'保养计划编号'" name="'tool.code'" value="" cssClass="'underline'"  />
	 			<@ww.textfield label="'保养计划名称'" name="'tool.code'" value="" cssClass="'underline'"  />
	 		</tr>
	 		<tr>
	 		...
	 		<tr>
	 			<@pp.dateRanger label="'计划执行日期'" name="'repair.estimate.time0'"
