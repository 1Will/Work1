...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='${req.contextPath}/preview/check/listCheckRulesItems.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
            <tr>
                <@ww.textfield label="'定期检查标准编号'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
                <@ww.textfield label="'检查检查标准名称'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
            </tr>
            <@deviceSelector/>  
             ...
             <tr>
            	...
            	<@ww.textfield label="'检查负责人'" name="'area.code'" value="" cssClass="'underline'" required="true"/>
            </tr>     
            <tr>
            	<@ww.textfield label="'检查内容'" name="'area.code'" value="" cssClass="'underline'" required="true"/>
                <@ww.textfield label="'检查要求'" name="'area.code'" value="" size="50" cssClass="'underline'" />
            </tr>
	        <tr>
       	...
       	<@buttonBar>
        	...
        	<@redirectButton value="${action.getText('back')}" url="${req.contextPath}/preview/check/listCheckRules.html"/>	
        </@buttonBar>
    </@ww.form>
    
    
	<ul id="beautytab">
		<li><a id="planItems" href="${req.contextPath}/preview/check/listCheckRulesItems.html" target="frame" class="selectedtab">定期检查标准明细</a></li>	    		  
	</ul>
