...
<script language="JavaScript" type="text/JavaScript"> 
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@buttonBar>
        	<@redirectButton value="${action.getText('save')}" url="${req.contextPath}/preview/tool/repair/listRepairPlans.html"/>	
        	<@redirectButton value="${action.getText('submit')}" url="#"/>
        	<@redirectButton value="打印整月计划" url="#"/>
        	<@redirectButton value="${action.getText('back')}" url="${req.contextPath}/preview/tool/repair/listRepairPlans.html"/>	
        </@buttonBar>
        

    </@ww.form>
    <ul id="beautytab">
		<li><a id="preRepairItems" onclick="activeTab(this)" href="listRepairPlanItems.html" target="frame" class="selectedtab">维修计划明细</a></li>
		<li><a id="preRepairSpareItems" onclick="activeTab(this)" href="listRepairPlanSpare.html" target="frame" >维修计划备件明细</a></li>	    		  
		<li><a id="preRepairRuleFee" onclick="activeTab(this)" href="listPreRepairRuleFee.html" target="frame" >维修计划费用明细</a></li>	  
		<li><a id="preRepairRuleManHour" onclick="activeTab(this)" href="listPreRepairRuleManHour.html" target="frame" >维修计划工时明细</a></li>	  
		<li><a id="preRepairRuleTool" onclick="activeTab(this)" href="listPreRepairRuleTool.html" target="frame" >维修计划工具明细</a></li>	  
	</ul>
