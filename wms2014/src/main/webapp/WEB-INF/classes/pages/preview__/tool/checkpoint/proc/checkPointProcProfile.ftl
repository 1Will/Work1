...
<script language="JavaScript" type="text/JavaScript"> 
 	...
 	window.onload = function () {
				...
				document.getElementById("extInfo").className = "selectedtab";
				}
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>    
        	<tr>	        	
	        	...
	        	<@ww.textfield label="'点检计划名称'" name="'area.code'" value=""  required="false" cssClass="'underline'" disabled="true"/>      
	      	</tr>     	
        	 <tr>
	     	...
	     	<tr>
	        	<@ww.textfield label="'运行台时合计(时)'" name="'area.code'" value=""  required="false" cssClass="'underline'" readonly="true" disabled="true"/>
	        	<@ww.textfield label="'停机台时合计(时)'" name="'area.code'" value=""  required="false" cssClass="'underline'" readonly="true" disabled="true"/>
	        	<@ww.textfield label="'故障台时合计(时)'" name="'area.code'" value=""  required="false" cssClass="'underline'" readonly="true" disabled="true"/>
	      	</tr>
        </@inputTable>
       	<@buttonBar>
