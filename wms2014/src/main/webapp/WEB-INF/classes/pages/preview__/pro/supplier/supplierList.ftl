...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../pro/supplier/editSupplier.html'; 
 		document.getElementById("elseInfo").className = "selectedtab";
 	}
...
<#include "/pages/preview__/pro/supplier/suppliersBase.ftl" />
    
	<ul id="beautytab">
	    <li>
	    	 <a id="elseInfo" onclick="activeTab(this);" href="../supplier/editSupplier.html" target="frame" >供应商附加信息</a>
	    </li>
		<li>
			<a id="ext"  onclick="activeTab(this);" href="../supplier/listSuppliersDevice.html" target="frame" >产品列表</a>
		</li>
	    <li>
	    	<a id="finance" onclick="activeTab(this);" href="../supplier/listSupplierHistory.html" target="frame" >历史信息查询</a>
	    </li>
	    <li>
	       <a id="levelInfo" onclick="activeTab(this);" href="../supplier/supplierNoLevelInfo.html" target="frame" >供应商级别变更历史</a>
	    </li>
	</ul>
