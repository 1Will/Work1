	    ...
	    <script language="JavaScript" type="text/JavaScript">
	       window.onload = function () {
	            <#if preRepairPlan.id?exists>
		            ...
		            getObjByNameRe("preRepairPlanDetail").className = "selectedtab";
	            </#if>
		  ...
		  */
		  ...
		  function validateTime_beginDate(){
			...
			var date=getObjByNameRe("preRepairPlan.beginDate").value;
		  ...
		  function validateTime_planCreatedTime(){
			...
			var date=getObjByNameRe("preRepairPlan.planCreatedTime").value;
