          ...
          window.onload = function() {
           <#if preRepairPlanDetail?exists>
              if (document.forms[0].elements["planProcFlag"].value == 'PLAN') {
                parent.getObjByNameRe("preRepairPlanDetail.allFee").value = '${preRepairPlanDetail.planAllFee?if_exists}';
              } else {
                parent.getObjByNameRe("PreRepairProcDetail.allFee").value = '${preRepairPlanDetail.procAllFee?if_exists}';
              }
            </#if>
            <#if repairPlanOrProcDetail?exists>
              if (document.forms[0].elements["planProcFlag"].value == 'PLAN') {
                parent.getObjByNameRe("repairPlanOrProcDetail.planDetailAllFee").value = '${repairPlanOrProcDetail.planDetailAllFee?if_exists}';
              } else {
                parent.getObjByNameRe("repairPlanOrProcDetail.procDetailAllFee").value = '${repairPlanOrProcDetail.procDetailAllFee?if_exists}';
              }
            </#if>
          }
