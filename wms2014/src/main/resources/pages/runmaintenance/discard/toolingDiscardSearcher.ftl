...
<script language="javascript">
  getObjByNameRe("toolingDevFlag").value = 'true';
  ...
  function checkInvalidParms() {
	...
	if (getObjByNameRe("discard.status").value == 'true') {
	  getObjByNameRe("agreeStatus").value = 'true';
	} else if (getObjByNameRe("discard.status").value == 'false') {
	   getObjByNameRe("dissentStatus").value = 'false';
	}
 ...
 <#-- function changeDisabledButton() {
    if (getObjByNameRe("includeDisabled").checked) {
      getObjByNameRe("delete").value="${action.getText('enabled')}";
    } else {
      getObjByNameRe("delete").value="${action.getText('disabled')}";
    }
  }-->
