  ...
  <@ww.form namespace="'/runmaintenance/discard'" name="'discard'" action="'saveDiscardBill'" method="'post'">
   ...
   window.onload = function() {
        <#if discardBill.department?exists>
         getObjByNameRe("department.id").value = #{discardBill.department.id};
      ...
      */
      ...
      function discard_Vlidate() { 
        if(getObjByNameRe("discardBill.discardBillName").value==''){
	  ...
	  <#-- if(getObjByNameRe("discardBill.reportDate").value==''){
	        alert('${action.getText('discardBill.reportDate.not.null')}');
	        return false;
	      }
	    var date=getObjByNameRe("discardBill.reportDate").value;
	   ...
	   if(getObjByNameRe("discardBill.discardReason").value!=''){
      ...
      */
      function validateTime_checkDate(){
		if(getObjByName('discardBill.reportDate').value ==""){
			alert("${action.getText('discardBill.reportDate.not.null')}");
			return false;
		}
