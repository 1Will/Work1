    ...
    <script language="JavaScript" type="text/JavaScript">
      window.onload = function() {
        ...
        <#if trusteeship.trusteeshipDepartment?exists>
         ...
         getObjByNameRe("trusteeshipDepartment.id").value = #{trusteeship.trusteeshipDepartment.id};
        </#if>
        <#if trusteeship.supplier?exists>
         getObjByNameRe("supplier.id").value = #{trusteeship.supplier.id};
        </#if>
        <#if loginUser.department?exists>
         getObjByNameRe("trusteeshipRequestDepartment.id").value = #{loginUser.department.id};
        </#if>
        <#if trusteeship.trusteeshipRequestDepartment?exists>
         getObjByNameRe("trusteeshipRequestDepartment.id").value = #{trusteeship.trusteeshipRequestDepartment.id};
        </#if>
        <#if trusteeship.id?exists>
     ...
     function migrate_Vlidate(){
       if(getObjByNameRe("trusteeship.billName").value==''){
      ...
      if(getObjByNameRe("trusteeship.trusteeshipUser").value==''){
	   ...
	   if(getObjByNameRe("trusteeship.trusteeshipRequestDate").value==''){
	        alert('${action.getText('trusteeship.trusteeshipRequestDate.not.null')}');
	        return false;
	      }   
	    var date=getObjByNameRe("trusteeship.trusteeshipRequestDate").value;
		...
		if(!isDateLessEqualThenCurrent(date)){
	        ...
	        if(getObjByNameRe("trusteeship.reason").value!=''){
