  ...
  <script language="JavaScript" type="text/JavaScript">
     window.onload = function() {
       ...
       <#if inventoryBill.department?exists>
	     getObjByNameRe("department.id").value = #{inventoryBill.department.id};
	   </#if>
	   <#if inventoryBill.id?exists>
	 ...
	 function inventory_Vlidate(){
	   if(getObjByNameRe("inventoryBill.name").value=='') {
	   ...
	   if(getObjByNameRe("inventoryPeople.name").value=='') {
	      alert('${action.getText('inventory.people.not.null')}');
	      return false;
	   }
	   if(getObjByNameRe("inventoryBill.inventoryDate").value=='') {
	     alert('${action.getText('inventoryBill.inventoryDate')}');
	     return false;
	   } else {
	     var date=getObjByNameRe("inventoryBill.inventoryDate").value;
		...
		if(getObjByNameRe("inventoryBill.comment").value!=''){
