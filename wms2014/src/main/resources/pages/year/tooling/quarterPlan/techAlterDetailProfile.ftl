...
<@htmlPage title="${action.getText('techAlterDetailDetailProfile.title')}">
 <base target="_self">
   <@ww.form namespace="'/popup'" name="'techAlterDetail'" action="'saveQuarterTechAlterDetail'" method="'post'" validate="true">
	 ...
	 -->
	   ...
	   <tr>
       <tr>
         <@ww.textfield label="'${action.getText('allPrice')}'" name="'techAlterDetail.allPrice'" value="'${(techAlterDetail.allPrice?string('#,###,##0.00'))?if_exists}'" cssClass="'underline'" disabled="false"/>
	     <@pp.datePicker label="'${action.getText('requestDate')}'" name="'techAlterDetail.requestDate'"
