...
<base target="_self">
  <@ww.form name="'listQuarterPlan'" action="'searchPurchaseRepairMaintenanceDetailSelector'" method="'post'">
    ...
    <#assign itemNo = 1/>
 	<@list title="${action.getText('sparePurchaseDetailSelector.title')}" 
           includeParameters="planNo|planName|name|department.id|subscribeId|detailType|qarterType|category.id|planFinishedDate_start|planFinishedDate_end" 
