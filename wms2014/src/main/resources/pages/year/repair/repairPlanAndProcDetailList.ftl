   	...
   	<script language="javascript">
        ...
        <#if repairPlanOrProc.id?exists>
          if (document.forms[0].elements["planProcFlag"].value == 'PLAN') {
            parent.getObjByNameRe("repairPlanOrProc.planAllFee").value = '${repairPlanOrProc.planAllFee?if_exists}';
          } else {
            parent.getObjByNameRe("repairPlanOrProc.procAllFee").value = '${repairPlanOrProc.procAllFee?if_exists}';
          }
        </#if>
      }
   	  /*
