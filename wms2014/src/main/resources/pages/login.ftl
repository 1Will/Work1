...
function enableTooltips(id){
  ...
  var links,i,h;
  if(!getObjByNameRe || !document.getElementsByTagName) return;
  AddCss();
  ...
  if(id==null) {
    ...
    links=getObjByNameRe(id).getElementsByTagName("a");
  }
...
function showTooltip(e){
  getObjByNameRe("btc").appendChild(this.tooltip);
  Locate(e);
}

function hideTooltip(e){
  var d=getObjByNameRe("btc");
...
function Locate(e){
  ...
  getObjByNameRe("btc").style.top=(posy+10)+"px";
  getObjByNameRe("btc").style.left=(posx-20)+"px";
}
