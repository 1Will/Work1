...
<base target="_self">
	...
	<@ww.form name="'acceptBillDetail'" action="'saveAcceptBillDetail'" method="'post'" validate="true">
	 ...
	 <script language="javascript">	
       ...
       if(getObjByNameRe("acceptBillDetail.acceptProject").value=='' ){
    ...
    if(getObjByNameRe("acceptBillDetail.acceptSituation").value!=''){
     ...
     if(getObjByNameRe("acceptBillDetail.handleOpinion").value!=''){
     ...
     if(getObjByNameRe("acceptBillDetail.memo").value!=''){
