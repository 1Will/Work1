...
<script language="JavaScript" type="text/JavaScript">
      ...
      //按月份供应商pdf
       function open_subscribeSupplierPdf(){
	       ...
	       var url="${req.contextPath}/reports/subscribe/subscribeDtlMonthSupplierView.pdf?supplier="+getObjByName("supplier.name").value+"&date_start="+getObjByName("purchaseDate_start").value+"&date_end="+getObjByName("purchaseDate_end").value+"&purIds="+purIds;  
           url = encodeURI(url);
	   ...
	   function open_subscribeSupplierXls(){
	      ...
	      if(checkInvalidParms()==false){
	       ...
	       var url="${req.contextPath}/reports/subscribe/subscribeDtlMonthSupplierView.xls?supplier="+getObjByName("supplier.name").value+"&date_start="+getObjByName("purchaseDate_start").value+"&date_end="+getObjByName("purchaseDate_end").value+"&purIds="+purIds;  
           url = encodeURI(url);
           window.open(url,"_new","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=screen.width,height=screen.height,left=0,top=0"); 
	   } 
