...
<script language="JavaScript" type="text/JavaScript">
       ...
       function open_subscribePdf(){
	       checkInvalidParms();
	       var url='${req.contextPath}/reports/subscribe/subscribeDetailMonthView.pdf?date_start='+getObjByName("subscribeDate_start").value+"&date_end="+getObjByName("subscribeDate_end").value+"&department.id="+getObjByName("department.id").value;  
           url = encodeURI(url);
	   ...
	   function open_subscribeXls(){
	       checkInvalidParms();
	       var url='${req.contextPath}/reports/subscribe/subscribeDetailMonthView.xls?date_start='+getObjByName("subscribeDate_start").value+"&date_end="+getObjByName("subscribeDate_end").value+"&department.id="+getObjByName("department.id").value;  
           url = encodeURI(url);
           window.open(url,"_new","toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,width=screen.width,height=screen.height,left=0,top=0"); 
	   }   
