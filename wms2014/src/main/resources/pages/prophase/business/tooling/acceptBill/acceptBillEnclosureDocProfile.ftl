...
<@htmlPage title="${action.getText('acceptBillDoc.title1')}">
 <base target="_self">
	<@ww.form  namespace="'/tooling/acceptBillSelector'" name="'AcceptBillEnclosureDoc'" action="'saveAcceptBillEnclosureDoc'" method="'post'" enctype="'multipart/form-data'" validate="true">
