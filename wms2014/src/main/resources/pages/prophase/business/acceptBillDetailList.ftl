...
<@framePage title="${action.getText('purchaseBillDetails.title')}">	
	...
	<@ww.form name="'listForm'" action="'sercherAcceptBillDtl'" method="'post'">
   ...
   <script language="javascript">
	    function open_acceptBillDtlDialog(acceptId,acceptBillDtlId) {
        		var url = '${req.contextPath}/accept/editAcceptBillDetail.html?&readOnly=${req.getParameter('readOnly')?if_exists}&acceptBill.id=' + acceptId;
