...
<#--$Id: supplierSearch.ftl 11283 2008-03-12 02:37:38Z zbzhang $ -->
      ...
      <script language="javascript">
       ...
       function checkInvalidParms(){
           if (getObjByNameRe("cartory.name").value==-1){
              getObjByNameRe("cartory.name").value='';
           }
     ...
     <#--
       function getQueryString(returnValue){
           ...
           var endValue;
           if(startPos!=-1){
              getObjByNameRe("maxValue").value=returnValue.substring(startValue+1,stringLength);
              getObjByNameRe("minValue").value='';
           }
          ...
          if(startPos!=-1){
             getObjByNameRe("minValue").value=returnValue.substring(startValue+1,stringLength);
             getObjByNameRe("maxValue").value='';
          }
          ...
          if(startPos!=-1){
             ...
             getObjByNameRe("minValue").value=returnValue.substring(startValue+4,endValue-1);
             getObjByNameRe("maxValue").value=returnValue.substring(endValue+4,stringLength);
          }
       }
       -->
      </script>
