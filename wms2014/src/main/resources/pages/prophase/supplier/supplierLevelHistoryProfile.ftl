...
<@htmlPage title="${action.getText('supplierlevle.title')}">
    ...
    function validateLevel(){
         ...
         if(getObjByNameRe("supplierLevelHistory.changDate").value==''){
	        alert('${action.getText('supplierLevelHistory.changDate')}');
	        return false;
	      }
	    var date=getObjByNameRe("supplierLevelHistory.changDate").value;
		...
		if(getObjByNameRe("supplierLevelHistory.changeReason").value!=''){
	...
	if(getObjByNameRe("supplierLevelHistory.origLevelId").value==getObjByNameRe("supplierLevelHistory.newLevel").value) {
