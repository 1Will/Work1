...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='${req.contextPath}/preview/plan/year/appendDevice/listAppendDeviceDetail.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
        	<tr>
                <@ww.textfield label="'新增设备计划编号'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="false"/>
                <@ww.textfield label="'新增设备计划名称'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="true"/>
            </tr>
            <tr>
            </tr>
                <@dept1/>
            ...
            <tr>
                <@ww.textfield label="'总费用'" name="'area.code'" value="" cssClass="'underline'" readonly="true" required="false"/>
            </tr>
    ...
    <ul id="beautytab">
		<li><a id="preRepairItems" onclick="activeTab(this)" href="${req.contextPath}/preview/plan/year/appendDevice/listAppendDeviceDetail.html" target="frame" class="selectedtab">计划明细</a></li>	    		  
		<#--
