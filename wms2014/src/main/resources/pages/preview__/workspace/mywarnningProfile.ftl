...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='listReader.html';
	...
	function sampleDocDetail_openDialog() {
	 ...
	 <@ww.form name="'listForm'" action="'searchProducts'" method="'post'" validate="true">
	 	  ...
	 	  <@inputTable>
	 	  	   <tr>
	 	  	  	<@ww.textfield label="'文档类型'"  name="'area.code'" value="'点检标准'" cssClass="'underline'" readonly="true"/> 
	 	  	  </tr>
	 	  	  <tr>
	 	  	  	<@ww.textfield label="'文档编号'"  name="'area.code'" value="'001'" cssClass="'underline'" readonly="true"/> 		
	 	  	  	<@ww.textfield label="'文档名称'"  name="'area.code'" value="'点检实施报告'" cssClass="'underline'" readonly="true"/> 		
	 	  	  </tr>
	 	  	  <tr>
	 	  	  	<@ww.textfield label="'部门'"  name="'area.code'" value="'生产部'" cssClass="'underline'" readonly="true"/> 	
	 	  	  	<@ww.textfield label="'提交时间'"  name="'area.code'" value="'2007-07-01'" cssClass="'underline'" readonly="true"/> 	
	 	  	  </tr>		
	 	  	  <tr>
	 	  	  	<@ww.textarea label="'阅读意见'" 
	 	...
	 	<@buttonBar>
	        	<@vbutton class="button" value="已读" onclick="javascript:void(0);"/>
	        	<@vbutton class="button" value="未读" onclick="javascript:void(0);"/>
	        	<@vbutton class="button" value="文档详细" onclick="sampleDocDetail_openDialog();"/>
	        	<@redirectButton  value="返回" url="listUnReadWarnning.html"/>
	     </@buttonBar>
	</@ww.form>
	
	<ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="listReader.html" target="frame" class="selectedtab">通知人列表</a></li>	
	</ul>
