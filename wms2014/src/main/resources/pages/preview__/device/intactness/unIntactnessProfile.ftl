...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["details"].click();
 		document.all.frame.src='${req.contextPath}/preview/device/intactness/deviceDeviceIntactnessDetails.html'  ; 
    ...
    <@ww.form namespace="'/device/inventory'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
            <tr>
                <@ww.textfield label="'鉴定编号'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
                <@ww.textfield label="'鉴定名称'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
            </tr>
            <tr>
                <@dept1/>
            	<td align="right" valign="top"><label class="label"><font color="red">*</font>鉴定人:</label></td>
	        	<td>
		      ...
		      <tr>
            	<@pp.datePicker label="'鉴定日期'" name="'repair.actual.time0'"
		 		...
		 		<script language="javascript">
		 			function changeSealedFaultState() {
		 				if (document.forms[0].elements["unusedAgree"].checked == true) {	
		 					...
		 					getObjByNameRe("requestIdea2").style.display='inline';	
		 				}else{
		 					getObjByNameRe("requestPeople").style.display='none';	
		 					getObjByNameRe("requestIdea2").style.display='none';
		 				}
		 			}				    
		 		</script>
       	...
       	<@buttonBar>
       		...
       		<@redirectButton value="返回" url="${req.contextPath}/preview/device/intactness/listDeviceIntactness.html"/>
        </@buttonBar>
    ...
    <ul id="beautytab">
		<li>
			<a id="details"  onclick="activeTab(this);" href="${req.contextPath}/preview/device/intactness/deviceDeviceIntactnessDetails.html" target="frame" >鉴定明细</a>
		</li>	   
	</ul>
