...
<@htmlPage title="设备保养计划维护">
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../device/maintenance/maintenancePlanDeviceList.html';
        ...
        <@inputTable>
	     ...
	     <tr>
       	...
       	<@buttonBar>
        	...
        	<@redirectButton value="${action.getText('back')}" url="${req.contextPath}/preview/device/maintenance/listMaintenancePlans.html"/>	
	...
	<ul id="beautytab">
		<li>
		<a id="maintenanceDeviceList" onclick="activeTab(this);" class="selectedtab" href="../../device/maintenance/maintenancePlanDeviceList.html" target="frame" >保养计划明细</a>
		</li>	
