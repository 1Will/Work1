...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../device/maintenance/listMaintenanceProcItemDetails.html';
	...
	function userUnSealedSelectorHandler(result) {
	 ...
	 <@ww.form name="'listForm'" action="'searchProducts'" method="'post'">
	 	<@inputTable>
           ...
           <tr>
                <td align="right" valign="top"><label class="label"><font color="red">*</font>实际执行人:</label></td>
	        	<td>
		       ...
		       <@pp.datePicker label="'实际完成日期'" name="'repair.actual.time0'"
	 ...
	 <ul id="beautytab">	 
	 		<li><a id="preRepairItemDetails" onclick="activeTab(this)" href="../../device/maintenance/listMaintenanceProcItemDetails.html" target="frame">维修明细</a></li>
	</ul>
