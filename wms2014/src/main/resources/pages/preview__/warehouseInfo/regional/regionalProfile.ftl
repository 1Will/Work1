	...
	<@ww.form  name="'listFrom'" action="'saveWeekly_'" namespace="'/warehouseInfo_'" method="'post'" >
     	 <@ww.token name="saveWeekly_Token"/>
     	  <@inputTable>
		     ...
		     <tr>
				<@ww.textfield label="'库区编码'" name="'code'" value="'0001'" cssClass="'underline'" disabled="true"/>
				<@ww.textfield label="'库区名'" name="'code'" value="'一号库区'" cssClass="'underline'" required="true"/>
		  		<@ww.select label="'仓库'"
	                    	name="area.code"
	                    	headerValue=""
	                    	list="{
