...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../pro/purchase/listPurchaseBillItems.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
       	...
       	<@buttonBar>
       		<@redirectButton value="${action.getText('save')}" url="${req.contextPath}/pro/purchase/listPurchaseBillsDEVICE.html"/>	
        	<@redirectButton value="${action.getText('back')}" url="${req.contextPath}/pro/purchase/listPurchaseBillsDEVICE.html"/>	
        </@buttonBar>
    </@ww.form>
    
    
	<ul id="beautytab">
		<li><a id="ruleItems" onclick="activeTab(this)" href="../../pro/purchase/listPurchaseBillItems.html" target="frame">采购单明细</a></li>
		<li><a id="attach"  onclick="activeTab(this)"  href="../../pro/purchase/listPurchaseBillAttachs.html" target="frame">采购单附件</a></li>
		...
		<li><a id="supply"  onclick="activeTab(this)"  href="../../pro/purchase/viewSupplierInfo.html" target="frame">供应商信息</a></li>  
 	    <li><a id="middleCheck"  onclick="activeTab(this)"  href="../../pro/purchase/middleCheckInfomation.html" target="frame">中期检查</a></li>  
		<li><a id="fundsItems"  onclick="activeTab(this)"  href="../../pro/purchase/fundsItemsInfomation.html" target="frame">付款明细</a></li>
	</ul>
