...
<@htmlPage title="附加工具">
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
            ...
            <tr>
            	<@ww.textfield label="'工具名称'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
                <@ww.textfield label="'工具型号'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
            </tr>
            <tr>
                <@ww.textfield label="'工具规格'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
                <@ww.textfield label="'工具数量'" name="'area.code'" value="" cssClass="'underline'" readonly="true"/>
            </tr>                                    
            <tr>
