...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../tool/purchase/listRequestBillItems.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
			...
			<@budgetSelector/>                
            <tr>
                <@ww.textfield label="'申购原因'" name="'area.code'" value="" size="50" cssClass="'underline'" readonly="" required="true"/>
                <@ww.textfield label="'备注'" name="'area.code'" value="" size="50" cssClass="'underline'" readonly=""/>
            </tr>
        </@inputTable>

        
       	<@buttonBar>
       		<@redirectButton value="${action.getText('save')}" url="listRequestBillsTOOLING.html"/>	
       		<@redirectButton value="${action.getText('submit')}" url="listRequestBillsTOOLING.html"/>	
        	<@redirectButton value="${action.getText('back')}" url="listRequestBillsTOOLING.html"/>	
        </@buttonBar>
    </@ww.form>
    
	<ul id="beautytab">
		<li><a id="ruleItems" onclick="activeTab(this)" href="listRequestBillItems.html" target="frame" >申购单明细</a></li>	    		  
		<li><a id="attachment" onclick="activeTab(this)" href="listRequestBillAttachs.html" target="frame" >申购单附件</a></li>
	</ul>
