...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='../../tool/purchase/listReceiveBillProcs.html';
    ...
    <@ww.form namespace="'/base/area'" name="'area'" action="'saveArea'" method="'post'" validate="true">
        ...
        <@inputTable>
            <tr>
                <@ww.textfield label="'验收单编号'" name="'area.code'" value=""  cssClass="'underline'" readonly="true" required="false"/>
                <@ww.textfield label="'验收单名称'" name="'area.code'" value=""  cssClass="'underline'" readonly="false"/>
             </tr>
             <tr>
                <@ww.textfield label="'采购单编号'" name="'area.code'" value=""  cssClass="'underline'" readonly="true" required="" disabled="true"/>
                <@ww.textfield label="'采购单名称'" name="'area.code'" value=""  cssClass="'underline'" readonly="true" disabled="true"/>
             </tr>
             <tr>
                <td align="right" valign="top"><label class="label">验收人:</label></td>
	        	<td>
            ...
            <tr>
                <@ww.textfield label="'验收地点'" name="'area.code'" value=""  cssClass="'underline'" readonly="false" required="false" />
             </tr>    
             <@audit2/>   
        </@inputTable>
        ...
        <@buttonBar>
        	...
        	<@redirectButton value="${action.getText('back')}" url="${req.contextPath}/preview/tool/purchase/listReceiveBills.html"/>	
        </@buttonBar>        
    </@ww.form>
    
    
	<ul id="beautytab">
		<li><a id="procs" onclick="activeTab(this)" href="../../tool/purchase/listReceiveBillProcs.html" class="selectedtab" target="frame"  >验收详细</a></li>	    		  
	   <li><a id="spares" onclick="activeTab(this)" href="../../tool/purchase/listReceiveBillSpares.html" target="frame"  >备品备件表</a></li>	    		  
	   <li><a id="tools" onclick="activeTab(this)" href="../../tool/purchase/listReceiveBillTools.html" target="frame"  >附加工具</a></li>	    		  
	   <li><a id="docs" onclick="activeTab(this)" href="../../tool/purchase/listReceiveBillDocs.html" target="frame"  >附加文档</a></li>	    		  
	</ul>
