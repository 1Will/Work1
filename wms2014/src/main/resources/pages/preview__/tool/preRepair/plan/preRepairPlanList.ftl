...
<@htmlPage title="保养计划查询">
	 <@ww.form name="'listForm'" action="" method="'post'">
		 <#include "preRepairPlanSearcher.ftl"/>
	 	<@buttonBar>
        	<@redirectButton value="${action.getText('search')}" url="#"/>
        	<@redirectButton value="${action.getText('new')}" url="editPreRepairPlan.html"/>     
        </@buttonBar>
        <table width="100%" border="0" cellspacing="2" cellpadding="0" class="w01_11px_grey">
	        <@listTable>
	        	...
	        	<tr>
	        		...
	        		<td style="text-align:left"><a href="editPreRepairPlan.html" >2008070122100</a></td>
	        	...
	        	<tr>
	        		<td><input type="checkbox" name="checkbox" value="true"></td>
	        		<td style="text-align:left"><a href="editPreRepairPlan.html">2008070155600</a></td>
