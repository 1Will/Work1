...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["details"].click();
 		document.all.frame.src='${req.contextPath}/preview/tooling/inventory/toolingInventoryDetails.html'  ; 
    ...
    <ul id="beautytab">
		<li>
			<a id="details"  onclick="activeTab(this);" href="${req.contextPath}/preview/tooling/inventory/toolingInventoryDetails.html" target="frame" >清查明细</a>
		</li>	   
	</ul>
