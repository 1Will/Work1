...
<script language="JavaScript" type="text/JavaScript"> 
	window.onload = function () {
		//		document.forms["area"].elements["ext"].click();
 		document.all.frame.src='listCalibrationItems.html';
	...
	function userSelectorHandler(result) {
	 ...
	 <@ww.form name="'accident'" action="'searchProducts'" method="'post'" validate="true">
	 	  ...
	 	  <@inputTable>
	 	  	  <tr>
	 	  	  	<@ww.textfield label="'标定计划编号'" name="'area.code'" value="'0001'" cssClass="'underline'" disabled="true" readonly="true" />
	 	  	  	<@ww.textfield label="'标定计划名称'" name="'area.code'" value="" cssClass="'underline'" required="true" />
	 	  	  </tr>
		 	  <tr>
		 	  ...
		 	  <tr>
		 	  	<@ww.textfield label="'审核人'" name="'area.code'" value="" cssClass="'underline'" required="true" />
		 	  	<@ww.textfield label="'批准人'" name="'area.code'" value="" cssClass="'underline'" required="true" />
		 	  </tr>	  
        </@inputTable>
	 	  ...
	 	  <@buttonBar>
	        	...
	        	<@redirectButton  value="返回" url="listCalibrationPlans.html"/>
	     </@buttonBar>
	</@ww.form>
	
	<ul id="beautytab">
		<li><a id="planItems" onclick="activeTab(this);" href="listCalibrationItems.html" target="frame" class="selectedtab">标定明细</a></li>	
	</ul>
