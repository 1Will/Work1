	...
	<script language="javascript">
     <#--   
        ...
        function checkInvalidParms() {		   
			var startDate = getObjByNameRe("createdTime_start").value;
        	var endDate = getObjByNameRe("createdTime_end").value;
        	var strStartDate = new String(startDate);
        	var strEndDate = new String(endDate);
        	
        	if (getObjByNameRe("docType.id").value==-1) {
        		getObjByNameRe("docType.id").value='';
        	} 
