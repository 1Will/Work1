...
<script language="javascript" type="text/JavaScript">
     ...
     function onlyLessMinStockOrNotStatus(){
      if (getObjByNameRe("onlyLessMinStockCheckbox").checked) {
        getObjByNameRe("onlyLessMinStock").value = "true";
      } else {
        getObjByNameRe("onlyLessMinStock").value = "";
      }
    }
   <#if (action.isOnlyLessMinStock())>
     getObjByNameRe("onlyLessMinStockCheckbox").checked=true;
     onlyLessMinStockOrNotStatus();
   <#else>
     getObjByNameRe("onlyLessMinStockCheckbox").checked=false;
     onlyLessMinStockOrNotStatus();
   </#if>
   
   function onlyEmptyMinStockOrNotStatus(){
      if (getObjByNameRe("onlyEmptyMinStockCheckbox").checked) {
        getObjByNameRe("onlyEmptyMinStock").value = "true";
      } else {
        getObjByNameRe("onlyEmptyMinStock").value = "";
      }
    }
   <#if (action.isOnlyEmptyMinStock())>
     getObjByNameRe("onlyEmptyMinStockCheckbox").checked=true;
     onlyEmptyMinStockOrNotStatus();
   <#else>
     getObjByNameRe("onlyEmptyMinStockCheckbox").checked=false;
     onlyEmptyMinStockOrNotStatus();
   </#if>
</script>