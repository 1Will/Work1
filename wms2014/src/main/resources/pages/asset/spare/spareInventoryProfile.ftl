 ...
 <style type="text/css">
	...
	function open_SpareInventoryPdf(spareInventoryId) {
	 ...
	 window.onload=function(){
	  ...
	  <#--
	   <#if matchCheckbox=="T">
	     getObjByNameRe("matchCheckboxbox").checked=true;
	   </#if>
	   -->
	    setBillInfo();
	   ...
	   var billInfo="${inventoryBillInfo?if_exists}";
	     if(billInfo!=""){
	        var ary=billInfo.split(",");
	         getObjByNameRe("spareInventory.inventoryNo").value=ary[0];
              getObjByNameRe("spareInventory.name").value=ary[1];
	           getObjByNameRe("spareInventory.inventoryDateTm").value=ary[2];
	            getObjByNameRe("spareInventory.inventoryPeople").value=ary[3];
	            getObjByNameRe("spareInventory.comment").value=ary[4];
	        }
	}
         ...
         function updateCheckboxStatus(){
            ...
            if(getObjByNameRe("matchCheckboxbox").checked){
              getObjByNameRe("matchCheckbox").value="T";
              <#if spareInventory.id?exists>
	...
	function getSpareInventoryInfo(){
	  var ary=new Array();
	   ary.push((getObjByNameRe("spareInventory.inventoryNo").value).toString());
       	ary.push((getObjByNameRe("spareInventory.name").value).toString());
	     ary.push((getObjByNameRe("spareInventory.inventoryDateTm").value).toString());
	      ary.push((getObjByNameRe("spareInventory.inventoryPeople").value).toString());
	      ary.push((getObjByNameRe("spareInventory.comment").value).toString());
	      return ary;
	}
