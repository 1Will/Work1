...
-- 导出 place 的数据库结构
CREATE DATABASE IF NOT EXISTS `place` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `place`;
...
-- 正在导出表  place.areas 的数据：3,144 rows
...
-- 正在导出表  place.cities 的数据：345 rows
...
-- 正在导出表  place.provinces 的数据：34 rows
