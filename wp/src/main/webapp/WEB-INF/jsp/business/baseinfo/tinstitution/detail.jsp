...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/business/tinstitution/detail.js"></script>
</head>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="5"
				...
				<tr>
					<td colspan="6">&nbsp; <!-- hidden --> 
					    ...
					    <input type="hidden" name="versons" value="${tinstitution.versons}" />
						  
						<input type="hidden" name="createdTime" value="${tinstitution.createdTime}" />
						<input type="hidden" name="creator" value="${tinstitution.creator}" />
					</td>
				</tr>
				<tr>
					<td width="3%">&nbsp;</td>
