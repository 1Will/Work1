...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/business/department/detail.js"></script>
</head>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="5"
				...
				<tr>
					<td colspan="6">&nbsp; <!-- hidden --> 
					    ...
					    <input type="hidden" name="department.id" value="${tdepartment.department.id}" />
					    <input type="hidden" name="versons" value="${tdepartment.versons}" />
						  
						<input type="hidden" name="createdTime" value="${tdepartment.createdTime}" />
						<input type="hidden" name="creator" value="${tdepartment.creator}" />
					</td>
				</tr>
				<tr>
					<td width="3%">&nbsp;</td>
