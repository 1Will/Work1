...
<%@ include file="../../../../js/common/jqueryJs.jsp"%>
 <script type="text/javascript"
	src="${pageContext.request.contextPath}/js/business/contract/record/list.js"></script>
</head>
<body style="margin: 0px;" class="easyui-layout">
	...
	<div data-options="region:'center',iconCls:'icon-ok',border:false">
		<table id="plan_datagrid" title="开票记录列表">
		</table>
	</div>
	<div id="toolbar">
		...
		<shiro:hasPermission name="record:update">
