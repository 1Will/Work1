...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/business/custom/info/add.js"></script>
</head>
<body>
	<div style="padding: 5px;">
		<!--基础信息begin-->
		<form id="attr_form"  method="get">
			<input id="customId" type="hidden" name="id" value="${custom.id}" />
			<input type="hidden" name="createdTime" value="${custom.createdTime}" />
		    <input type="hidden" name="creator" value="${custom.creator}" />
			<table class="gp_maintable">
				<tr>
					<th width="11%"><div align="right">客户编码</div></th>
					<td width="15%"><div align="left">
							<input id=code value="${custom.code}"  readOnly="readonly" 
							required="required" size="30" class="easyui-validatebox textbox"
								name="code"></input> 
						</div></td>
					<th width="12%"><div align="right">客户名称</div></th>
					<td width="15%"><div align="left">
							<input id="name" value="${custom.name}"
								class="easyui-validatebox textbox" size="30" required="required"
								name="name"></input>
						</div></td>
					<th width="10%"><div align="right" >企业性质</div></th>
					<td width="15%"><div align="left">
							<select class="easyui-combobox" id="nature" name="nature" style="width:150px;">
								<c:forEach items="${qyxzList}" var="qyxzList">
									<option value="${qyxzList.codingname}">${qyxzList.cnname}</option>
								</c:forEach>
							</select>
						</div></td>
				</tr>
				<tr>
					<th width="11%"><div align="right">企业法人</div></th>
					<td width="15%"><div align="left">
							<input id=corporate value="${custom.corporate}" size="30" class="easyui-textbox"
								name="corporate"></input>
						</div></td>
					<th width="12%"><div align="right">注册资金</div></th>
					<td width="15%"><div align="left">
							<input id="registerCapital" value="${custom.registerCapital}"
								class="easyui-textbox" size="30" name="registerCapital"></input>
						</div></td>
					<th width="10%"><div align="right" >行业</div></th>
					<td width="15%"><div align="left">
							<select class="easyui-combobox" name="industry" style="width:150px;">
								<c:forEach items="${qyxzList}" var="qyxzList">
									<option value="${qyxzList.codingname}">${qyxzList.cnname}</option>
								</c:forEach>
							</select>
				...
				<tr>
					<th width="11%"><div align="right">创立日期</div></th>
					<td width="15%"><div align="left">
							<input name="createDate" class="easyui-datetimebox" value="${custom.createDate}" size="30"
								type="text"  required="required"></input>
						</div></td>
					<th width="12%"><div align="right">员工人数</div></th>
					<td width="15%"><div align="left">
							<input id="employeeNum" value="${custom.employeeNum}"
								class="easyui-textbox" name="employeeNum" size="30"></input>
						</div></td>
					<th width="10%"><div align="right">客户状态</div></th>
					<td width="15%"><div align="left">
							<select class="easyui-combobox" required="required" id="customerType" name="customerType" style="width:150px;">
								<c:forEach items="${khztList}" var="khztList">
									<option value="${khztList.codingname}">${khztList.cnname}</option>
								</c:forEach>
							</select>
						</div></td>
				</tr>
				<tr>
					<th width="11%"><div align="right">省</div></th>
					<td width="15%"><div align="left">
							<input id="province"  name="countryId" style="width: 150px" >
						</div></td>
					<th width="12%"><div align="right">市</div></th>
					<td width="15%"><div align="left">
						<input id="city"  name="provinceId" style="width: 150px" >
						</div></td>
					<th width="10%"><div align="right">县</div></th>
					<td width="15%"><div align="left">
							<select class="easyui-combobox" id="county" name="cityId"  style="width: 150px">
                              <option value="" selected="selected" >--请选择地区--</option>
                            </select>
						</div></td>
				</tr>
				<tr>
					<th width="11%"><div align="right">客户等级</div></th>
					<td width="15%"><div align="left">
							<select class="easyui-combobox" required="required" id="step" name="step" style="width:140px;">
								<c:forEach items="${khdjList}" var="khdjList">
									<option value="${khdjList.codingname}">${khdjList.cnname}</option>
								</c:forEach>
							</select>
						</div></td>
					<th width="12%"><div align="right">存档日期</div></th>
					<td width="40%" colspan="3"><div align="left">
							<input name="archiveTime" class="easyui-datetimebox" value="${custom.archiveTime}" size="30"
								type="text"></input>
						</div></td>
					
				</tr>
				<tr>
					<th width="11%"><div align="right">地址</div></th>
					<td width="15%" colspan="5"><div align="left">
							<input id="address" value="${custom.address}" 
							class="easyui-textbox" name="address" size="30"></input>
						</div></td>
				</tr>
				<tr>
					<th width="11%"><div align="right">企业简介</div></th>
					<td width="15%" colspan="5"><div align="left">
							<input class="easyui-textbox" data-options="multiline:true" id="businessScope" name="businessScope" value="${custom.businessScope}" style="width:990px;height:70px" />
						</div></td>
				</tr>
				
				
				<tr>
					<th width="11%"><div align="right">联系人</div></th>
					<td width="15%"><div align="left">
							<input id="maorContact" value="${custom.maorContact}" required="required" 
								class="easyui-validatebox textbox" name="maorContact" size="30"></input>
						</div></td>
					<th width="12%"><div align="right">部门</div></th>
					<td width="15%"><div align="left">
							<input id="dept" value="${custom.dept}"
								class="easyui-textbox" name="dept" size="30"></input>
						</div></td>
				...
				<tr>
					<th width="11%"><div align="right">职位</div></th>
					<td width="15%"><div align="left">
							<input id=duty value="${custom.duty}"  size="30" class="easyui-textbox"
								name="duty"></input>
						</div></td>
					<th width="12%"><div align="right">手机</div></th>
					<td width="15%"><div align="left">
							<input id="mobile" value="${custom.mobile}"
								class="easyui-textbox" size="30" name="mobile"></input>
						</div></td>
					<th width="10%"><div align="right" >办公电话</div></th>
					<td width="15%"><div align="left">
							<input id="phone" value="${custom.phone}"
								class="easyui-textbox" size="20" name="phone"></input>
						</div></td>
				</tr>
				<tr>
					<th width="11%"><div align="right">Email</div></th>
					<td width="15%"><div align="left">
							<input id=email value="${custom.email}" size="30" class="easyui-textbox"
								name="email"></input>
						</div></td>
					<th width="12%"><div align="right">QQ</div></th>
					<td width="15%" colspan="3"><div align="left">
							<input id="qq" value="${custom.qq}"
								class="easyui-textbox" size="30" name="qq"></input>
						</div></td>
				</tr>
				...
				<tr>
					...
					<td width="15%" colspan="5"><div align="left">
							<input class="easyui-textbox" data-options="multiline:true"  id="effectDescribe" name="effectDescribe" value="${custom.effectDescribe}" style="width:990px;height:70px"/>
						</div></td>
				</tr>
				<tr>
					<th width="11%"><div align="right">业务员</div></th>
					<td width="15%"><div align="left">
							<input id="businessmanId" value="${custom.businessmanId}"
								class="easyui-textbox" name="businessmanId" size="30" required="required"></input>
						</div></td>
					<th width="12%"><div align="right">部门</div></th>
					<td width="15%"><div align="left">
							<input id="parlorDept" value="${custom.parlorDept}"
								class="easyui-textbox" name="parlorDept" size="30"></input>
						</div></td>
					<th width="10%"><div align="right">信息来源</div></th>
					<td width="15%"><div align="left">
							<select class="easyui-combobox" required="required" id="source" name="source" style="width:140px;">
								<c:forEach items="${xxlyList}" var="xxlyList">
									<option value="${xxlyList.codingname}">${xxlyList.cnname}</option>
								</c:forEach>
							</select>
						</div></td>
				</tr>
				...
				<tr>
					<th width="11%"><div align="right">咨询内容</div></th>
					<td width="15%" colspan="5"><div align="left">
							<input class="easyui-textbox" data-options="multiline:true" id="advisoryContent" name="advisoryContent" value="${custom.advisoryContent}" style="width:990px;height:70px" />
						</div></td>
				</tr>
			</table>
		</form>
...
$(document).ready(function () {
	 ...
	 for (i = 1; i <= aCity.length; i++){
		 if (aCity[i - 1].substring(2, 6) == "0000"){
			 var ab = {};
			 ab['label'] = aCity[i - 1].substring(0, 6);
			 ab['value'] = aCity[i - 1].substring(7, aCity[i - 1].length);
			 data.push(ab);
		 }
	 }
	$("#province").combobox({
		...
		onChange: function (n,o) {
			var aa = $('#province').combobox('getValue');	
			 var provinceCode = aa / 10000;
			var data1 = new Array();
			 for (i = 1; i <= aCity.length; i++) {
