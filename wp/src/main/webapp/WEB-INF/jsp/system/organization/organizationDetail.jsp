...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/system/organization/organizationDetail.js"></script>
</head>
<body class="easyui-layout" fit="true">
	...
	<div region="center" border="false" style="padding: 5px;">
		<!--基础信息begin-->
		<form id="attr_form" action="saveOrUpdate" method="get">
					...
					<td>
						<div align="left">
							<input name="publishTime" class="easyui-datetimebox" value="${organization.publishTime}" size="30"
								type="text" editable="false"></input>
						</div>
					</td>
				...
				<tr>
					...
					<td width="55%" colspan="3"><div align="left">
							<textarea name="comments" value="${organization.comments}" id="comments"
								class="KindEditor" style="width: 750px; height: 400px;">${organization.comments}</textarea>
						</div></td>
					<td width="2%">&nbsp;</td>
				</tr>
			</table>
