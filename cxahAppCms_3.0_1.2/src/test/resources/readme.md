...
```
1、根据 /cxahAppCms_3.0/src/main/resources/properties/jdbc.properties 配置数据库

2、导入数据库 /cxahAppCms_3.0/src/test/resources/springwind.sql
...
4、配置 host 为  127.0.0.1 ah122.cn

5、访问：http://ah122.cn:8080 登录账户默认：  admin 管理员，密码 123 ，普通会员 test 密码  123
...
2、访问地址：http://ah122.cn:8080/role/list.html
```
