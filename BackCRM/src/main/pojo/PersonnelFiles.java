...
public class PersonnelFiles implements java.io.Serializable {
    ...
    private Date regularizedDate; //转正日期
    private Date separationDate; //离职日期
    private String address; //联系地址
    private Long instId; // 值为14
    private Long deptId ; //部门
    private Long dutyId; //职位 
    private Long marriage; //婚姻状况  172未婚    173已婚
    private Long birthplaceId; //出生地
    private Long workway; //88全职    89兼职
    private Long status; //状态     176在职    177离职   178试用  179实习
    private Integer disabled; //失效
    private Date createdTime; //登记时间
    ...
    private CodeValue businessType; //业务属性  军品 民品 军民品
	...
	public Long getWorkway() {
		return workway;
	}
	public void setWorkway(Long workway) {
