...
public class CSerialDriver implements SerialPortEventListener
{
	...
	public void setNewMsgMonitor(CNewMsgMonitor monitor) { this.newMsgMonitor = monitor; }
	public void killMe() { stopFlag = true; }

	public void open() throws Exception
	{
		log.info("CSerialDriver(): Connecting...");
	...
	public void emptyBuffer() throws Exception { while (dataAvailable()) inStream.read(); }
	...
	{
		log.info("TE: " + formatLog(new StringBuffer(s)));
		for (int i = 0; i < s.length(); i++) { outStream.write((byte) s.charAt(i)); }
		outStream.flush();
	}
