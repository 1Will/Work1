...
/**
	This class contains some information about the GSM modem/phone as well as some
	simple statistics (total inbound/outbound messages).
*/
public class CDeviceInfo
{
	...
	*/
	public boolean getGprsStatus() { return gprsStatus; }

	/**
		Returns the Statistics object, which holds the total number of inbound & outbound
		messages since restart.
