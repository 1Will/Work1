...
//				String hql = "select p from PersonnelFiles p  where p.dept.id = 48 and p.duty.id = 84";
				String hql = "select p from PersonnelFiles p  where p.dept.id = "+code1+" and p.duty.id = "+code2+"";
