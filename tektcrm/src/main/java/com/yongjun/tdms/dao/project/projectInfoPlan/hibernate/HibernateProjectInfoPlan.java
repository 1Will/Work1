...
/*    */ {
	 				     ...
	 				     Session session = getSession();
	 				      try {
	 				    	 Integer maxOrder=1;
 					          ...
 					          if(map.get("productionOperationDetailId")!=null){
					        	   sb.append(" and p.productionOperationDetail.id ='"+map.get("productionOperationDetailId")+"'");
					           }
	...
	public List<ProjectInfoPlan> loadAllProjectInfoPlansByHql(String hql) {
