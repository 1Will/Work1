...
public class ProjectInfo extends BaseInfoEntity {
	...
	private long contractManagementSum =  Long.valueOf(0L);//合同数，默认为0
	...
	public long getContractManagementSum() {
		return contractManagementSum;
	}

	public void setContractManagementSum(long contractManagementSum) {
		this.contractManagementSum = contractManagementSum;
	}
