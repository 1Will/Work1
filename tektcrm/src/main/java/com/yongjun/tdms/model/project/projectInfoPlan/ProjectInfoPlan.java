...
public class ProjectInfoPlan extends BaseInfoEntity {
	...
	private ProductionOperationDetail productionOperationDetail;//生产经营计划详细
	...
	private CodeValue productionPoint;// 计划名称id 只用于生成经营计划
	private ContractManagement contractManagement;
	private String isSaved;// 提交判断
    private Integer orderNumber=0;//排序
    private ProjectInfoPlan projectInfoPlan_2;//前置任务
    private String isExport;//0为不可导（未作修改），1则需要修改，2则需要插入
    
	public ProjectInfoPlan getProjectInfoPlan_2() {
		return projectInfoPlan_2;
	}

	public void setProjectInfoPlan_2(ProjectInfoPlan projectInfoPlan_2) {
		this.projectInfoPlan_2 = projectInfoPlan_2;
	}
	...
	public CodeValue getProductionPoint() {
		return productionPoint;
	}

	public void setProductionPoint(CodeValue productionPoint) {
