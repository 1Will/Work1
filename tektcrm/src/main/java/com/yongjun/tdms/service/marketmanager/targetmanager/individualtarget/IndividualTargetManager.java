package com.yongjun.tdms.service.marketmanager.targetmanager.individualtarget;

import com.yongjun.pluto.exception.DaoException;
import com.yongjun.tdms.model.marketmanager.targetmanager.individualtarget.IndividualTarget;
import java.util.List;

public abstract interface IndividualTargetManager
{
  ...
  public abstract void disabledAllIndividualTarget(List<IndividualTarget> paramList);

  public abstract void enabledAllIndividualTarget(List<IndividualTarget> paramList);

  public abstract String getMaxPFCode(String paramString);
}

/* Location:           E:\crm2010\110\crm2009\WEB-INF\classes\
 * Qualified Name:     com.yongjun.tdms.service.marketmanager.targetmanager.individualtarget.IndividualTargetManager
