...
/*     */   public DefaultProductTypeManager(ProductTypeDao productTypeDao,CodeValueManager codeValueManager,YongJunSequenceManager yongJunSequenceManager)
/*     */   {
...
/*     */   public void storeProductType(ProductType productType) {
        	if(productType.isNew()){
        	  String code1 =(String)this.yongJunSequenceManager.generateeCodeTypeReplacFormtter(YongJunSequenceConstant.CODE_PRODUCT,"CPLB");
  		      productType.setCode(code1);
        	}
