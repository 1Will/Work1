...
/*     */   public DefaultWeeklyManager(WeeklyDao weeklyDao, YongJunSequenceManager yongJunSequenceManager)
/*     */   {
...
/*     */   {
				if(weekly.isNew()){
					weekly.setCode((String)this.yongJunSequenceManager.generateByCodeType(YongJunSequenceConstant.CODE_WEEKLY));
					}
