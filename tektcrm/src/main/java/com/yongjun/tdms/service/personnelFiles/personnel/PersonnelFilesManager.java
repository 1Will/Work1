...
public abstract interface PersonnelFilesManager
{
  ...
  public abstract String savePersonnelFilesfoByImp(List<PersonnelFiles> PersonnelFiles)throws DaoException;
  public abstract List<PersonnelFiles> loadByName (Long code1,Long code2);
}
