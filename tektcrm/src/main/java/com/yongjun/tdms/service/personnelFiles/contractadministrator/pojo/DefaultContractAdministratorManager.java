...
/*     */   public DefaultContractAdministratorManager(ContractAdministratorDao contractAdministratordao,YongJunSequenceManager yongJunSequenceManager)
/*     */   {
...
/*     */   {
			if(pf.isNew()){
				pf.setContractCode((String)this.yongJunSequenceManager.generateByCodeType(YongJunSequenceConstant.CODE_PERSONNELFILE_CONTRACTMANAGERMENT));
			    }
