...
public class EditProjectInfoAction extends PrepareAction {
	...
	public EditProjectInfoAction(CodeValueManager codeValueManager, ProjectInfoManager projectInfoManager,
			...
			EventTypeManager eventTypeManager, PersonnelFilesToUserManager personnelFilesToUserManager,ProjectInfoCustomerManager projectInfoCustomerManager,DataManager dataManager,DepartmentManager departmentManager) {
	...
	public void prepare() throws Exception {
		if (this.projectInfo == null)
			if (hasId("projectInfo.id")) {
				...
				if (this.userManager.getUser().getCode()!=null && this.userManager.getUser().getCode().length()>0) {
