...
public class ListProjectInfoPlanAction extends ValueListAction {
    ...
    private String projectInfoPlanId;
	...
	protected Map getRequestParameterMap() {
		...
		if (hasId("productionOperationDetail.id")) {
			map.put("productionOperationDetailId", getId("productionOperationDetail.id"));
		}
		if (hasId("contractManagement.id")) {
			map.put("contractManagementId", getId("contractManagement.id"));
		}
		if (hasId("projectInfoPlan.id")) {
			this.projectInfoPlanId=request.getParameter("projectInfoPlan.id");
	...
	public void prepare() throws Exception {
		...
		if (hasId("productionOperationDetail.id")) {
			this.productionOperationDetailId = this.request.getParameter("productionOperationDetail.id");
		}
	...
	public String getProjectInfoPlanId() {
		return projectInfoPlanId;
	}

	public void setProjectInfoPlanId(String projectInfoPlanId) {
		this.projectInfoPlanId = projectInfoPlanId;
	}
