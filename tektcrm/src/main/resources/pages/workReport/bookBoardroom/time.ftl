	...
	<@pp.datePicker 
			...
			value="'${(bookBoardroom.startDate?string('yyyy-MM-dd'))?if_exists}'" 
			cssClass="'underline'" 
			required="true"
			readonly="true"
			dateFormat="'%Y-%m-%d'"
   ...
   <td>
		   ...
		   <select name="startMinute">
			...
			<@pp.datePicker
					...
					value="'${(bookBoardroom.endDate?string('yyyy-MM-dd'))?if_exists}'" 
					cssClass="'underline'" 
					required="true"
					readonly="true"
					dateFormat="'%Y-%m-%d'"
	...
	<#if bookBoardroom.id?exists>
		<script>
		var start = '${(bookBoardroom.startDate?string('kk:mm'))?if_exists}';
		var end = '${(bookBoardroom.endDate?string('kk:mm'))?if_exists}';
		if(start != ''){
