...
<@htmlPage title="${action.getText('周计划维护')}" >
     ...
     <@ww.token name="saveWeekPlanToken"/>
		    ...
		    <tr>
		    	...
		    	<td colspan="10">
			        <textarea id="weekPlan.lastPlan" name="weekPlan.lastPlan" rows="4" readOnly="readOnly"><#if weekPlan.id?exists>${weekPlan.lastPlan?if_exists}<#else>${lastPlan?if_exists}</#if></textarea>
		        </td>
		         <script language="javascript">
					 var width=document.body.clientWidth/9;
								getObjByName("weekPlan.lastPlan").cols =width;
				 </script>
			</tr>
			<tr>
				<td align="right" valign="top">
		    	...
		    	<td colspan="10">
			        <textarea id="weekPlan.thisPlan" name="weekPlan.thisPlan" rows="4"  ><#if weekPlan.id?exists>${weekPlan.thisPlan?if_exists}</#if></textarea>
		        </td>
		         <script language="javascript">
					 var width=document.body.clientWidth/9;
								getObjByName("weekPlan.thisPlan").cols =width;
				 </script>
			</tr>
			<tr>
				<td align="right" valign="top">
		    	...
		    	<td colspan="10">
			        <textarea id="weekPlan.nextPlan" name="weekPlan.nextPlan" rows="4"  ><#if weekPlan.id?exists>${weekPlan.nextPlan?if_exists}</#if></textarea>
		        </td>
		         <script language="javascript">
					 var width=document.body.clientWidth/9;
								getObjByName("weekPlan.nextPlan").cols =width;
				 </script>
		  	</tr>
		  	<tr>
     	  </@inputTable>
