...
<@ww.form name="'listForm'" action="'editLeaveBill_'" method="'post'">
	...
	<@inputTable>
		...
		<tr>
		 <@ww.textfield label="'时长（天）'" name="'approvalPerson'" value="'2'" cssClass="'underline'"/>
			<@ww.select 
	    		label="'状态'"
				required="true"
				name="'state'" 
		...
		<tr>
			 <@ww.textfield label="'负责人'" name="'approvalPerson'" value="'陈晓松'" cssClass="'underline'"/>
			<@pp.datePicker 
				label="'审批时间'" 
				name="'approvalTime'" 
	   			value="'2011-2-17'"
		...
		<tr>
			<@ww.textarea label="'事由'" name="'incident'" value="'生病了'" rows="'3'" cols="'100'"/>
		</tr>
		<tr>
