...
<@ww.hidden name="'readOnly'" value="'${req.getParameter('readOnly')?if_exists}'"/>
	...
	<tr>
		...
		<td align="right" valign="top">
            ...
            <td>
	             <input type="text" name="customerInfo.name" value="${customerInfo.name?if_exists}" class="underline" onblur="" autocomplete="off">
	...
	<tr>
		...
		<!--注册资本-->	
		<@ww.textfield label="'${action.getText('customerInfo.registeredCapital')}'" name="'customerInfo.registeredCapital'" value="''" cssClass="'underline'" />
	</tr>
	<tr>
		<!--员工人数-->
...
<script language="JavaScript" type="text/JavaScript">
	...
	<#else>
	getObjByName("departmentShow").value = "<#if personnelFiles.dept?exists>${personnelFiles.dept.id}</#if>";
	</#if>
	var type_msg = "";
	var btype = "";
	var businessType_id = "";
