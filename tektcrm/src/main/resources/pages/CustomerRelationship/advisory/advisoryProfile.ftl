	...
	<@inputTable>
	   ...
	   <tr>
	   	<!--地址-->
			...
			<td colspan="3">
				<input type="text" name="advisory.address" value="${advisory.address?if_exists}" class="underline" maxlength="70" size="60" ></input>
			</td>
	   	<!---->
	   </tr>
	   <tr>
	   	...
	   	<td align="right" valign="top">
	        ...
	        <td colspan="5">
	        	<textarea name="advisory.enterpriseSynopsis" rows="4"  >${advisory.enterpriseSynopsis?if_exists}</textarea>
	        </td>
	         <script language="javascript">
			var width=document.body.clientWidth/9;
						getObjByName("advisory.enterpriseSynopsis").cols =width;
		   </script>
	   	<!---->
	   </tr>
	   ...
	   <td align="right" valign="top">
	        ...
	        <td colspan="5">
	        	<textarea name="advisory.effectDescribe" rows="4"  >${advisory.effectDescribe?if_exists}</textarea>
	        </td>
	         <script language="javascript">
			var width=document.body.clientWidth/9;
						getObjByName("advisory.effectDescribe").cols =width;
		   </script>
	  ...
	  <@textfield label="${action.getText('资料完整度')}" name="advisory.customerInfoIntegrity"  value="${advisory.customerInfoIntegrity?if_exists}" required="false" cssClass="underline" maxlength="20" readonly="true"/>		
	   ...
	   <tr>
	   	...
	   	<td align="right" valign="top">
	        ...
	        <td colspan="5">
	        	<textarea name="advisory.advisoryContent" rows="4"  >${advisory.advisoryContent?if_exists}</textarea>
	        </td>
	         <script language="javascript">
			var width=document.body.clientWidth/9;
						getObjByName("advisory.advisoryContent").cols =width;
		   </script>
	   	<!---->
	   </tr>
	   <!--***********************************************************************************-->
	...
	function storeValidation(){
		...
		if(getObjByName('advisory.advisoryTime').value ==''){
		 	...
		 	if(!isDate('advisory.advisoryTime')){
				...
				alert("咨询时间：${action.getText('dateTimeFormat.error')}");
