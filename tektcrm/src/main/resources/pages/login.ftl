...
<head id="head1">
	<title id="Title_CPLogin">合肥天鹅制冷科技客户关系管理系统</title>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
          <td height="33" align="center" ><font color="#ffffff" size="3"><strong>Copyright 2017-2020 HEFEI TIANE REFERIGERATION TECHNOLOGY All Rights Reserved 合肥天鹅制冷科技有限公司版权所有</strong></font></td>
        </tr>
      </table>
</center>
