 <#--
	...
	LICENSEE AS A RESULT OF USING, MODIFYING OR DISTRIBUTING THIS SOFTWARE OR ITS
 	DERIVATIVES.
-->
<#--$Id: topFrame.ftl 10072 2009-12-16 08:53:12Z qsun $ -->
        ...
        <table width="100%">
           <tr>
              ...
              <font color="#ffffff">
                ...
                ${action.getText("user")}:<strong>${user.name}</strong></font>
                &nbsp;&nbsp;
...
<img src="${req.contextPath}/images/logo_crm.jpg"  height="110" width="69%"/>
</div>
