...
<@ww.form namespace="'/projectInfo'" name="'projectInfo'" action="'saveProPer'" method="'post'">
    ...
    <tr>
	        ...
	        <td colspan="10">
	        	<textarea name="projectInfoPersonnels.outline" rows="4"  >${projectInfoPersonnels.outline?if_exists}</textarea>
	        </td>
	         <script language="javascript">
			 var width=document.body.clientWidth/9;
						getObjByName("projectInfoPersonnels.outline").cols =width;
		   </script>
			<!---->
		</tr>
    </@inputTable>
