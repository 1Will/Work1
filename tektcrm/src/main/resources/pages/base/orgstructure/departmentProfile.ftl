         ...
         <@inputTable>
            ...
            <@ww.hidden name="'department.pDeptId'" value="${req.getParameter('department.pDeptId')?if_exists}"/>
             ...
             <tr>
                 ...
                 <@ww.textfield label="'${action.getText('department.name')}'" id="'department.name'" name="'department.name'" value="'${department.name?if_exists}'" cssClass="'underline'" required="true"/>
             </tr>
             <tr>
				<@ww.textfield label="'${action.getText('department.leader')}'" id="'department.leader'" name="'department.leader'" value="'${department.leader?if_exists}'" required="true" cssClass="'underline'"/>
             	<@ww.textfield label="'${action.getText('department.tel')}'" id="'department.tel'" name="'department.tel'" value="'${department.tel?if_exists}'"  cssClass="'underline'"/>
             </tr>
         </@inputTable>
    ...
    -->
     ...
     <script>
       ...
       function storeValidation(){
			if(getObjByName('department.name').value==''){
			...
			if(getObjByName('department.leader').value==''){
			...
			if(getObjByName('department.tel').value==''){
...
<ul id="beautytab">
	<li>
		<a id="additionalInfo" onclick="activeTab(this);" href='${req.contextPath}/orgstructure/editDepartmentLader.html?department.id=#{department.id}&readOnly=${req.getParameter('readOnly')?if_exists}' target="frame" >${action.getText('附加信息')}</a>
	</li>
</ul>
<iframe name="frame" frameborder="0.5" src="${req.contextPath}/orgstructure/editDepartmentLader.html?department.id=#{department.id}&readOnly=${req.getParameter('readOnly')?if_exists}" marginHeight="0" marginWidth="0" scrolling="auto" vspace=0 hspace=0 width="100%" height="100%"/>
</#if>
