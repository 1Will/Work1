...
function searchRecord(){
  ...
  document.pageForm.action="/docFileErrorAction.do?method=list&type=2";
  document.pageForm.submit();
}
function handleReport(errorid,fileid){
  document.pageForm.action="/docFileErrorAction.do?method=beforeUpdate&errorid="+errorid+"&fileid="+fileid+"&type=2";
  document.pageForm.submit();
}
...
<table width="98%" align="center">
  <TR>
    <TD class="page_title" colspan="2">微课报错</TD>
 </TR>
 <tr height="30">
   <td>
              ...
              <td class="bg_basecolor" align="left">
                <table cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    <td width="80" height="25" align="right">主讲名称:</td>
                    <td><input type="text" style="width: 180px;"  name="actors2" value="<bean:write name="actors"/>"/></td>
...
<TABLE width="98%" border=0 align="center">
  <TR>
    <TD align=center>
      <java2page:pager url="docFileErrorAction.do?method=list&type=2" name="pagelist" />
