...
function saveRecord(){
	...
	if(flag == "2010"){
  	...
  	obj.action="/checkDocFileInfoAction.do?method=<bean:write name="act"/>";
  	obj.submit();
}

function returnback(){
	obj = document.all("docFileInfoActionForm");
	obj.action='/checkDocFileInfoAction.do?method=list';
    obj.submit();
}
...
<TABLE class="page_maintable">
  ...
  <TR>
    <TD vAlign=top align=middle>
      <html:form action="/checkDocFileInfoAction.do" method="post">
       <TABLE width="100%" border=0 cellpadding=6 cellspacing=1 align="center" bgcolor="#cccccc">
          ...
          <tr>
            ...
            <td class="table_edit_left">
                <logic:equal value="1" name="model" property="convertstatus" >
                    <java2code:option name="docFileInfo.status" codetype="check" property="status"></java2code:option>
                </logic:equal>
                <logic:notEqual value="1" name="model" property="convertstatus" >
                <select name="docFileInfo.status">
       ...
       <input type="hidden" name="docFileInfo.caifu" value='<bean:write name="model" property="caifu"/>'>
       ...
       <input type="hidden" name="convertstatus" value="<bean:write name="convertstatus"/>">
