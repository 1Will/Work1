...
function saveRecord(){
	...
	if(flag == "2010"){
  	...
  	obj.action="/managerDocFileInfoAction.do?method=<bean:write name="act"/>";
  	obj.submit();
}
...
function returnback(){
	obj = document.all("docFileInfoActionForm");
	obj.action='/managerDocFileInfoAction.do?method=list';
    obj.submit();
}
...
<TABLE class="page_maintable">
  ...
  <TR>
    <TD vAlign=top align=middle>
      <html:form action="/managerDocFileInfoAction.do" method="post">
