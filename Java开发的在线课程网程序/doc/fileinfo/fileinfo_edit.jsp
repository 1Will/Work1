...
function saveRecord(){
	...
	if(flag == "2010"){
  	...
  	obj.action='/docFileInfoAction.do?method=<bean:write name="act"/>';
  	obj.submit();
}
function returnback(){
	obj = document.all("docFileInfoActionForm");
	obj.action='/docFileInfoAction.do?method=list';
    obj.submit();
}
function showDialog(){
...
<TABLE class="page_maintable">
  ...
  <TR>
    <TD vAlign=top align=middle>
      <html:form action="/docFileInfoAction.do" method="post">
