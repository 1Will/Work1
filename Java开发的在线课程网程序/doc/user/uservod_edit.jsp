...
function saveRecord(){
	obj = document.all("vodFilmInfoActionForm");
	...
	if(flag == "2010"){
  	...
  	obj.action="/vodUserFileAction.do?method=<bean:write name="act"/>";
  	obj.submit();
}
	...
	diag.CancelEvent = function(){
		if(diag.innerFrame.contentWindow.document.getElementById('uploadimageurl')){
			...
			if(uploadtip != ''){
				...
				document.vodFilmInfoActionForm.topreview.src="/upload_dir/"+uploadimageurl;
...
<TABLE class="page_maintable">
  <TR>
    <TD class="page_title">修改微课</TD>
  </TR>
  <TR>
    <TD vAlign=top align=middle>
      <html:form action="/vodUserFileAction.do" method="post">
          ...
          <tr>
            ...
            <table>
            	<tr>
            		...
            		<img src="<bean:write name="model" property="sketch"/>" width="220" height="125" border="1" onclick="uploadPhoto()" id=topreview>
            		<%}else{ %>
            		<img src="/upload_dir/<bean:write name="model" property="sketch"/>" width="220" height="125" border="1" onclick="uploadPhoto()" id=topreview>
            		<%} %>
            		</td>
            	</tr>
            	<tr>
       ...
       <input type="hidden" name="vodFilmInfo.homescroll" value="<bean:write name="model" property="homescroll"/>">
       <input type="hidden" name="vodFilmInfo.recommandtype" value="<bean:write name="model" property="recommandtype"/>">
       <input type="hidden" name="vodFilmInfo.downloads" value="<bean:write name="model" property="downloads"/>">
       <input type="hidden" name="vodFilmInfo.downloadcaifu" value="<bean:write name="model" property="downloadcaifu"/>">
       <input type="hidden" name="vodFilmInfo.money" value="<bean:write name="model" property="money"/>">
