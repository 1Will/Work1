...
function saveRecord(){
	...
	if(flag == "2010"){
  	...
  	obj.action="/docUserFileAction.do?method=<bean:write name="act"/>";
  	obj.submit();
}
...
function returnback(){
	obj = document.all("docFileInfoActionForm");
	obj.action='/docUserFileAction.do?method=list';
    obj.submit();
}
...
<TABLE class="page_maintable">
  ...
  <TR>
    <TD vAlign=top align=middle>
      <html:form action="/docUserFileAction.do" method="post">
       ...
       <input type="hidden" name="docFileInfo.recommand" value='<bean:write name="model" property="recommand"/>'>
