...
<title><%=Constants.SYS_PRODUCT_NAME %>-团队介绍</title>
...
<div class="view_main">
	<div class="view_left">
		...
		<a href="/v-aboutgroup-12-0.htm"><li class="hover">团队介绍</li></a>
	...
	<div class="view_right">
		<div class="view_right_01">
			<h3>团队介绍</h3>
			<div class="view_right_one" style="width:900px;min-height:330px;">
			内容美化中。。。
			</div>
		</div>
