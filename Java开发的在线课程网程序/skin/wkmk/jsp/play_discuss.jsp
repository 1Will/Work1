...
function toPage(start){
	...
	document.pageForm.action = '/v.bo?method=vdiscuss';
...
function addSaveDiscuss(){
	...
	if(temp == '1'){
		...
		document.pageForm.action = '/v.bo?method=addVdiscuss';
		document.pageForm.submit();
	}
}
...
<div class="detailed clearfix back_1">
  <ul class="ul_1">
    <li id="tab2"><a href="/v-vinfo-${f_unitid }-${filmid }.htm">课程简介</a></li>
  ...
  <div class="detailed_bottom">
    <div class="form_2 clearfix">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="9%" align="left" style="font-size:32px;color:#333"><bean:write name="vodFilmInfo" property="score"/></td>
...
var options	= { 
		...
		after_click : function(ret) {
		    this.url = '/v.bo?method=addScoreToFilm&filmid=<bean:write name="vodFilmInfo" property="filmid"/>&score='+ret.value;
