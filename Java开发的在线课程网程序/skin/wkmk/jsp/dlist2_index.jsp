...
<div class="clearfix">
  ...
  <div class="list clearfix">
    ...
    <iframe id="listFrame" name="listFrame" src="/v.bo?method=dlist2f&xueduan=${xueduan }&subject=${subject }&column=${column }&orderbytype=${orderbytype }" width="900" height="70" onload="SetCwinHeight()" frameborder="0" scrolling=no></iframe>
  </div>
</div>
</div>
</form>
...
function gotoLink(id, knopointid){
	...
	document.getElementById('listFrame').src = '/v.bo?method=dlist2f&xueduan=${xueduan }&subject=${subject }&orderbytype=${orderbytype }&column='+knopointid;
}
</script>
