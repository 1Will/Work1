  ...
  <div class="list clearfix">
    <div class="seach_tab_1">
        ...
        <ul>
          ...
          <li><a href="javascript:gotoUrl('${subjectid }', '${gradeid }', '5')" <%if("5".equals(orderbytype)){ %>class="link1"<%} %>>下载量</a></li>
          <li><a href="javascript:gotoUrl('${subjectid }', '${gradeid }', '6')" <%if("6".equals(orderbytype)){ %>class="link1"<%} %>>页数</a></li>
        </ul>
        <div class="seach2">
