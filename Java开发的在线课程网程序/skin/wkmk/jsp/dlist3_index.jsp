...
<div class="clearfix">
  ...
  <div class="list clearfix">
    ...
    <iframe id="listFrame" name="listFrame" src="/v.bo?method=dlist3f&version=${version }&column=${column }&orderbytype=${orderbytype }" width="900" height="70" onload="SetCwinHeight()" frameborder="0" scrolling=no></iframe>
  </div>
</div>
</div>
</form>
...
function gotoLink(id, columnid){
	...
	document.getElementById('listFrame').src = '/v.bo?method=dlist3f&version=${version }&orderbytype=${orderbytype }&column='+columnid;
}
</script>
