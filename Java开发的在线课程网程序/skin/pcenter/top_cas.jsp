...
<div id="comm_top_right">
    ...
    <logic:present name="loginfailure" scope="application">
 	...
 	<logic:notPresent name="loginfailure" scope="application">
       ...
       &nbsp;&nbsp;<a style="cursor:pointer;text-decoration:underline;" onclick="javascript:indexLoginAction()">登录</a>&nbsp;&nbsp;<a style="color:#ccc;">|</a>&nbsp;&nbsp;<a style="cursor:pointer;" onclick="javascript:register()">注册</a></div>
      <%}else{ %>
