...
<div style="float: left" id="my_menu" class="sdmenu">
	...
	<div>
		...
		<a id="menu_1" class="sdmenu_onclick" onclick="setLocation('sysUserInfoAction.do?method=list','1','8')" onmouseover="changeBg('1','menu_1')" onmouseout="changeBg('2','menu_1')">用户管理</a>
		<%-- <a id="menu_2" onclick="setLocation('sysUnitInfoAction.do?method=list','2','8')" onmouseover="changeBg('1','menu_2')" onmouseout="changeBg('2','menu_2')">单位管理</a>--%>
		<a id="menu_2" onclick="setLocation('sysRoleInfoAction.do?method=list','2','8')" onmouseover="changeBg('1','menu_2')" onmouseout="changeBg('2','menu_2')">角色管理</a>
		<a id="menu_3" onclick="setLocation('sysUserGroupAction0.do?method=main','3','8')" onmouseover="changeBg('1','menu_3')" onmouseout="changeBg('2','menu_3')">机构管理</a>
		<a id="menu_4" onclick="setLocation('sysUnitInfoAction.do?method=beforeUpdateSelf','4','8')" onmouseover="changeBg('1','menu_4')" onmouseout="changeBg('2','menu_4')">站点信息</a>
		<a id="menu_5" onclick="setLocation('sysUnitInfoAction.do?method=beforeUpdateSeo','5','8')" onmouseover="changeBg('1','menu_5')" onmouseout="changeBg('2','menu_5')">SEO优化</a>
		<a id="menu_6" onclick="setLocation('gpwKeywordFilterAction.do?method=beforeUpdate','6','8')" onmouseover="changeBg('1','menu_6')" onmouseout="changeBg('2','menu_6')">关键字过滤</a>
		<a id="menu_7" onclick="setLocation('cmsTemplateUnitAction.do?method=setSite','7','8')" onmouseover="changeBg('1','menu_7')" onmouseout="changeBg('2','menu_7')">系统设置</a>
		<a id="menu_8" onclick="setLocation('sysUserLogAction.do?method=list','8','8')" onmouseover="changeBg('1','menu_8')" onmouseout="changeBg('2','menu_8')">系统日志</a>
    <br/>
    </div>
</div><!--#left导航结束-->
