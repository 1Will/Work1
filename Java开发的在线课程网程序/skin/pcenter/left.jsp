...
%>
<h3><a href="/adminAutoLogin.do"><img src="/public/images/pcenter/c01-1.jpg"/></a></h3>
<%}else{ %>
<h3><a href="/pcenter.do?method=index&mproduct=vod"><img src="/public/images/pcenter/c01.jpg"/></a></h3>
<%} %>
...
<p style="height:10px;line-height:10px;">&nbsp;</p>
	...
	%>
      <div>
        <span <%if(i > 3){ %>id="hidden_div_<%=i-3 %>"<%} %>><%=moduleInfo.getModulename() %></span>
      <%
