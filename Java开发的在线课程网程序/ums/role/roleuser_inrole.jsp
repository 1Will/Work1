...
function doOnLoad(){
 	window.parent.frames["left"].location = '/sysUserRoleAction1.do?method=outroleuser&productid=<bean:write name="productid"/>&unitid=<bean:write name="unitid"/>&roleid=<bean:write name="roleid"/>' ; 
}
function delUser(){
  if(num>0){
	...
	if (checkids=="") {
	 ...
	 if(confirm(str)){
	   document.pageForm.action="/sysUserRoleAction1.do?method=deleteroleuser";
...
function delUserAll(){
  if(num>0){
	  ...
	  if(confirm(str)){
	    document.pageForm.action="/sysUserRoleAction1.do?method=deleteroleuserall";
	    document.pageForm.submit();
	  }
  }
}
...
function searchRecord(){
  ...
  document.pageForm.action="/sysUserRoleAction1.do?method=inroleuser";
  document.pageForm.submit();
}
</script>
       ...
       <TABLE width="100%" align=center border=0><!--serach end-->
              ...
              <TR>
                <TD vAlign=top borderColor=#ffffff align="right">
                   <java2page:pager url="sysUserRoleAction1.do?method=inroleuser" name="pagelist" style="2"/>
