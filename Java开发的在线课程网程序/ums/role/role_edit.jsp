...
function saveRecord(){
  ...
  obj.action="sysRoleInfoAction1.do?method=<bean:write name="act"/>";
  obj.submit();
}

function goBack(){
  obj = document.all("sysRoleInfoActionForm");
  obj.action="sysRoleInfoAction1.do?method=list";
  obj.submit();
}
</SCRIPT>
</HEAD>
...
<TABLE class="page_maintable" width="98%">
  ...
  <TR>
    <TD vAlign=top align="center">
      <html:form action="/sysRoleInfoAction1.do" method="post" >
          ...
          <tr>
            ...
            <td class="table_edit_left">
             <select name="sysRoleInfo.state"  style="width:60">
                ...
                <logic:equal property="state" name="model" value="1">
          ...
          <tr>
            ...
            <td class="table_edit_left">
             <select name="sysRoleInfo.state"  style="width:60">
                ...
                <logic:equal property="state" name="model" value="2">
                   <option value=0 >禁用</option>
                   <option value=1>在用</option>
                   <option value=2 selected>系统</option>
                </logic:equal>
              </select>
            </td>
          </tr>
