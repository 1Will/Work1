...
<script type="text/javascript">
	function searchRecord() {
		...
		document.pageForm.action = "/sysUserStatisticAction.do?method=main";
			 ...
			 <input type="hidden" name="type" id="type"  value="3">
					<table cellpadding="0" cellspacing="0">
						<tr>
							...
							<td><input type="text" id="endtime" size="12" name="enddate"
				...
				<a href="/sysUserStatisticAction.do?method=dowload&jpeg=${chart }"><span>导出</span></a>
				</td>
			</tr>
			<tr>
