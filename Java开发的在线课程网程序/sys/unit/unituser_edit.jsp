...
if(value3.length != 0){
  ...
  obj.action="/sysUnitUserInfoAction.do?method=<bean:write name="act"/>";
  obj.submit();
}
...
<TABLE class="page_maintable" width="100%">
  ...
  <TR>
    <TD vAlign=top align="center">
      <html:form action="/sysUnitUserInfoAction.do" method="post" >
       <TABLE width="750" align=center border="0">
          ...
          <tr>
            <td align="left" colspan="2" >(<font color="red">如果不修改,请保持用户密码和确认密码为空)</font>&nbsp;&nbsp;</td>
           </tr>
          </logic:notEqual>
