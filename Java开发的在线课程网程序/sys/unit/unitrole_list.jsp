...
function addRecord(){
  document.pageForm.action="sysUnitRoleInfoAction.do?method=beforeAdd";
...
function getRoleModule(roleid){
	...
	diag.CancelEvent = function(){
		document.pageForm.action="sysUnitRoleInfoAction.do?method=list";
		document.pageForm.submit();
		diag.close();
	};
	diag.show();
...
<table width="98%" align="center">
 ...
 <tr>
   <td>
      ...
      <INPUT class="btn_del"  onclick="delRecord('sysUnitRoleInfoAction.do?method=delBatchRecord')" type="button" value="删除" name="btndel">
    </td>
     <TD align="right">
     </TD>
 </tr>
...
<!--循环列出所有数据-->
  <logic:iterate id="model" name="pagelist" property="datalist" indexId="index">
     ...
     <td>
        <java2page:button url="/sysUnitRoleInfoAction.do" property="roleid" readonly="E"/>
...
<TABLE width="98%" border=0  align="center">
  <TR>
    <TD align=center>
       <java2page:pager url="sysUnitRoleInfoAction.do?method=list" name="pagelist"/>
