...
function searchRecord(){
  document.pageForm.action="sysUserPointAction.do?method=list";
...
<table width="98%" align="center">
  <TR>
    <TD class="page_title" colspan="2">积分明细</TD>
 </TR>
 <tr height="30">
   <td>
...
<tr >
    ...
    <TD width="80" class="table_title">用户名</TD>
...
<TABLE width="98%" border=0 align="center">
  <TR>
    <TD align=center>
      <java2page:pager url="sysUserPointAction.do?method=list" name="pagelist" />
    </TD>
  </TR>
</TABLE>
</FORM>
