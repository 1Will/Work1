      ...
      <html:form action="/sysUserInfoAction.do" method="post" >
       <TABLE width="480" align=center border="0">
          ...
          <tr>
            ...
            <td class="table_edit_left">
                <input id="sysUserInfo.birthday" name="sysUserInfo.birthday"  readonly="readonly" type="text" size="6" class=input value="<bean:write property="birthday"  name="model"/>" onFocus="WdatePicker({dateFmt:'yyyy-MM-dd',alwaysUseStartDate:true})">(日期格式：2008-08-08)&nbsp;
            </td>
          </tr>
           <tr>
            <td class="table_edit_right">邮件地址：</td>
            <td class="table_edit_left"><input id="sysUserInfo.email" name="sysUserInfo.email" CK_NAME="邮件地址" CK_TYPE="EMail" type="text" size="25" class=input value="<bean:write property="email"  name="model"/>"></td>
          </tr>
          <tr>
			...
			<table width="100%" id="t_table">
			  <tr>
			    <td style="width:330px;color:#000;">
				  ...
				  年&nbsp;&nbsp;&nbsp;&nbsp;级：&nbsp;<input name="gradename1" id="gradename1" readonly="readonly" onclick="selectSubject(1, 1)" type="text" value="" class=input style="width:100px;"/>
			    </td>
			...
			<%
			  ...
			  <tr>
			    <td style="width:330px;color:#000;">
				  ...
				  年&nbsp;&nbsp;&nbsp;&nbsp;级：&nbsp;<input name="gradename<%=ii+1 %>" id="gradename<%=ii+1 %>" readonly="readonly" onclick="selectSubject(1, <%=ii+1 %>)" type="text" value='<bean:write name="teaching" property="flago"/>' class=input style="width:100px;"/>
			    </td>
