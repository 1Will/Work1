...
<tr>
	<td width="48%" align="center">
		<IFRAME border="0" frameborder="no" height="450px" id="left" name="left" scrolling="no" src="sysUserGroupMemberAction.do?method=outmember&groupid=<bean:write name="groupid"/>" width="100%"></IFRAME>
	</td>
	...
	<td width="48%" align="center">
		<IFRAME border="0" frameborder="no" height="450px" id="right" name="right" scrolling="no" src="sysUserGroupMemberAction.do?method=inmember&groupid=<bean:write name="groupid"/>" width="100%"></IFRAME>
	</td>
</tr>
</TABLE>
