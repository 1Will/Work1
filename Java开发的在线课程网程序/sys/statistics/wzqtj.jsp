...
<table width="98%" align="center">
  <TR>
    <TD class="page_title" colspan="2">网站群统计</TD>
 </TR>
</table>
...
<TR onMouseover="chgTDbg(this,'on')" class="table_list" onMouseout="chgTDbg(this,'off')" bgcolor="#ffffff" >
    <TD align="right" width="200" ><bean:write name="SC_szxysubjectname"/>总数：</TD>
    <TD align="left" width="250" style="font-weight:bold;color:#0055ee;">&nbsp;<bean:write name="size"/></TD>
</tr>
<TR onMouseover="chgTDbg(this,'on')" class="table_list" onMouseout="chgTDbg(this,'off')" bgcolor="#ffffff" >
