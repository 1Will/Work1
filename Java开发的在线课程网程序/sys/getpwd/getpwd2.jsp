...
<div id="center"> 
	...
	<div id="list">
		...
		<ul>
			...
			<li>
				<dt>注册邮箱：</dt>
				<dd style="width:163px;"><input name="email" id="pwdanswer" type="text" value=""  style="width:153px; height:24px; background:url(/public/images/register/z19.jpg) no-repeat; line-height:24px; padding-left:5px; border:none;" />
				</dd>
				<dd class="two" id="getpwd1">请填写注册时填写的邮箱地址！</dd>
			</li>
		</ul>
