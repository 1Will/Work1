...
<TABLE class="page_maintable" width="100%">
  <TR>
    <TD class="page_title">[<bean:write property="codedata" name="codeData"/>]码表值</TD>
  </TR>
  <TR>
    <TD vAlign=top align="center">
      <html:form action="/sysCodeDataAction.do" method="post" >
       <TABLE width="300" align=center border=0>
          ...
          <tr>
            <td class="table_edit_right" width="30%">编&nbsp;&nbsp;&nbsp;&nbsp;号：</td>
            <td class="table_edit_left"><input type="text" CK_NAME="<bean:write property="codeno" name="model"/>编号"  name="sysCodeData.codeno" size="10"  class=input value="<bean:write property="codeno"  name="model"/>">*</td>
          </tr>
           <tr>
