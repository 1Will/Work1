/*
   ...
   DERIVATIVES.
 */
/* $Id: jsrsClient.js 6119 2007-07-30 08:24:26Z qsun $ */
...
function contextPOST( rsPage, parms ){
...
function contextGET( rsPage, parms ){
...
function jsrsExecute( rspage, callback, parms, visibility ){
  ...
  if ( jsrsPOST && ((jsrsBrowser == 'IE') || (jsrsBrowser == 'MOZ'))){
    contextObj.POST( rspage, parms );
  } else {
    contextObj.GET( rspage, parms );
  }  
