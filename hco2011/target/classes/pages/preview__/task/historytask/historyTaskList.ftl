...
<@htmlPage title="${action.getText('待办任务')}">
	<@ww.form name="'listForm'" action="'listHistoryTask_'" method="'post'">
		<@ww.token name="listHistoryTask_ReportToken"/>
		...
		<@listTable>
			...
			<tr>
				<td>1</td>
				<td style="text-align:left"><a href="editHistoryTask_.html">001</a></td>
				...
				<td style="text-align:left"><a href="editHistoryTask_.html">查看</a></td>
			</tr>
			<tr>
				<td>2</td>
				<td style="text-align:left"><a href="editHistoryTask_.html">002</a></td>
				<td style="text-align:left">请假单</td>
				<td style="text-align:left">请假单主管审核</td>
			...
			<tr>
				<td>3</td>
				<td style="text-align:left"><a href="editHistoryTask_.html">003</a></td>
				<td style="text-align:left">请假单</td>
				<td style="text-align:left">请假单主管审核</td>
