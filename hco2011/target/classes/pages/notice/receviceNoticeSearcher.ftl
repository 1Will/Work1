...
function checkInvalidParms() {
      if (document.getElementById("readStatus").value == -1) {
          document.getElementById("readStatus").value = '';
        }
       var startSendDate = document.getElementById("receviceDate_start").value;
       var endSendDate = document.getElementById("receviceDate_end").value;
