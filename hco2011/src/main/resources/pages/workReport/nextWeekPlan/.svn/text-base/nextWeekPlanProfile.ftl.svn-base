     	 ...
     	 <@ww.token name="saveNextWeeklyPlanToken"/>
     	  <@inputTable>
			...
			<tr>
		        ...
		        <td colspan="10">
		       	<textarea name="nextWeekPlan.workPlan" rows="4" cols="95" >${nextWeekPlan.workPlan?if_exists}</textarea>
		        </td>
			</tr>				
			<tr>
				<td align="right" valign="top">
		        ...
		        <td colspan="10">
		        	<textarea name="nextWeekPlan.comment" rows="4" cols="95" >${nextWeekPlan.comment?if_exists}</textarea>
		        </td>
			</tr>
			</@inputTable>
		<@buttonBar>
