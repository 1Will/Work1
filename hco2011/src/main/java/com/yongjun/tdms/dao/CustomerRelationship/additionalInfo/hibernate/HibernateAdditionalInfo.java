...
/**
 * <p>Title: HibernateAdditionalInfo
 * <p>Description: 附加信息数据访问层接口实现类�</p>
 * <p>Copyright: Copyright (c) 2009 yj-technology</p>
 * <p>Company: www.yj-technology.com</p>
 * <p>@author wliu@yj-technology.com</p>
 * <p>@version $Id: HibernateAdditionalInfo.java 2009-12-7 15:45:03Z wliu $</p>
 */
public class HibernateAdditionalInfo
...
implements AdditionalInfoDao {
	...
	public AdditionalInfomation loadAdditionalInfo(Long aiId){
		...
		return super.load(AdditionalInfomation.class, aiId);
	}
	...
	public List<AdditionalInfomation> loadAllAdditionalInfo(){
		...
		return super.loadAll(AdditionalInfomation.class);
	}
	...
	public List<AdditionalInfomation> loadAllAdditionalInfo(Long[] aiIds){
		...
		return super.loadAll(AdditionalInfomation.class, aiIds);
	}
	...
	public List<AdditionalInfomation> loadByKey(String key, Object value) throws DaoException{
		...
		return super.loadByKey(AdditionalInfomation.class, key, value);
	}
}
