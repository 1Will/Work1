package com.yongjun.tdms.dao.personnelFiles.leavepersonnelfiles;
...
public abstract interface LeavePersonDao
{
 ...
 * Qualified Name:     com.yongjun.tdms.dao.personnelFiles.leavepersonnelfiles.LeavePersonDao
