...
public class RunTask extends BaseInfoEntity
	...
	public RunTask(long bussnessId, String name, Flow flow, PersonnelFiles submitPer, Date submitTime, Date createTime,
			String content, PersonnelFiles assignee, int myNum, String linkHref) {
		this.bussnessId = bussnessId;
		this.name = name;
		this.flow = flow;
		this.submitPer = submitPer;
