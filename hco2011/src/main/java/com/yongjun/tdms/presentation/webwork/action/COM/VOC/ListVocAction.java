...
/* 143 */       List one = this.codeValueManager.loadByKey("code", Long.valueOf("050"));
/*     */ 
...
/* 171 */       List one = this.codeValueManager.loadByKey("code", Long.valueOf("001"));
/*     */ 
...
/* 200 */       List one = this.codeValueManager.loadByKey("code", Long.valueOf("040"));
/*     */ 
