...
/*     */ 
/*     */   public EditProjectInfoPersonnelsAction(CodeValueManager codeValueManager, ProjectInfoManager projectInfoManager, PersonnelFilesManager personnelFilesManager, CustomerInfoManager customerInfoManager, ContactArchivesManager contactArchivesManager, UserManager userManager,ProjectInfoPersonnelsManager projectInfoPersonnelsManager)
/*     */   {
...
/*  55 */       if (hasId("projectInfoPersonnels.id")) {
/*  56 */         this.projectInfoPersonnels = this.projectInfoPersonnelsManager.loadProjectInfoPersonnels(getId("projectInfoPersonnels.id"));
/*     */       } else {
/*  58 */         this.projectInfoPersonnels = new ProjectInfoPersonnels();
/*     */       }
/*     */   }
/*     */ 
/*     */   public String save() {
/*  74 */     boolean isNew = this.projectInfoPersonnels.isNew();
/*     */ 
/*  76 */     if (hasId("projectInfo.id")) {
/*  77 */       ProjectInfo projectInfo = this.projectInfoManager.loadProjectInfo(getId("projectInfo.id"));
/*  78 */       this.projectInfoPersonnels.setProjectInfo(projectInfo);
/*     */     }
/*     */ 
...
/*     */     }
/*  86 */    
/*  91 */     if (hasId("proPerson.id")) {
/*  92 */       this.personnelFiles = this.personnelFilesManager.loadPersonnel(getId("proPerson.id"));
...
/* 172 */     if (isNew) {
/* 173 */       addActionMessage(getText("projectInfoPer.add.success", Arrays.asList(new Object[] { this.projectInfoPersonnels.getProPerson().getName() })));
/*     */ 
/* 175 */       return "success";
/*     */     }
/* 177 */     addActionMessage(getText("projectInfoPer.edit.success", Arrays.asList(new Object[] { this.projectInfoPersonnels.getProPerson().getName() })));
/* 179 */     return "success";
/*     */   }
/*     */ 
/*     */ 
...
/* 212 */       List one = this.codeValueManager.loadByKey("code", Long.valueOf("202"));
