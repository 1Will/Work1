...
/*     */ 
/*     */ public class ListBackVisitByContactAction extends ValueListAction
/*     */ {
...
/*     */   private final UserManager userManager;
            private Long contactArchiveId;
            private Long customerInfoId;
            private Long projectInfoId;
/*     */ 
/*     */   public ListBackVisitByContactAction(UserManager userManager)
/*     */   {
...
/*     */   {
	      if(hasId("contactArchive.id")){
	    	   this.contactArchiveId =this.getId("contactArchive.id");
	      }
	      if(hasId("customerInfo.id")){
	    	   this.customerInfoId =this.getId("customerInfo.id");
	      }
	      if(hasId("projectInfo.id")){
	    	   this.projectInfoId =this.getId("projectInfo.id");
	      }
...
/*     */   }
		public Long getContactArchiveId() {
			return contactArchiveId;
		}
		public void setContactArchiveId(Long contactArchiveId) {
			this.contactArchiveId = contactArchiveId;
		}
